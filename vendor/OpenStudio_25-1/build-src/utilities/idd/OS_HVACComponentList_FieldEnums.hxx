...
Handle, Name,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<OS_HVACComponentListFields>::integer_value()); }
   private:
...
HVACComponent,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<OS_HVACComponentListExtensibleFields>::integer_value()); }
   private:
