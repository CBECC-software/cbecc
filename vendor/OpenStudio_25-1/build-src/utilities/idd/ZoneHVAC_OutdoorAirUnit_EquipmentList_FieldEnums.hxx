...
Name,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<ZoneHVAC_OutdoorAirUnit_EquipmentListFields>::integer_value()); }
   private:
...
ComponentObjectType, ComponentName,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<ZoneHVAC_OutdoorAirUnit_EquipmentListExtensibleFields>::integer_value()); }
   private:
