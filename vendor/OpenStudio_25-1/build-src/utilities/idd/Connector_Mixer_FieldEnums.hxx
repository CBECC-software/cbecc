...
Name, OutletBranchName,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<Connector_MixerFields>::integer_value()); }
   private:
...
InletBranchName,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<Connector_MixerExtensibleFields>::integer_value()); }
   private:
