...
Name, InletNodeName,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<AirLoopHVAC_ZoneSplitterFields>::integer_value()); }
   private:
...
OutletNodeName,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<AirLoopHVAC_ZoneSplitterExtensibleFields>::integer_value()); }
   private:
