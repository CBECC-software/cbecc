...
class WindowProperty_AirflowControlFields: public ::EnumBase<WindowProperty_AirflowControlFields> {
 public: 
  enum domain 
  {
Name, AirflowSource, AirflowDestination, MaximumFlowRate, AirflowControlType, AirflowIsScheduled, AirflowMultiplierScheduleName, AirflowReturnAirNodeName,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<WindowProperty_AirflowControlFields>::integer_value()); }
   private:
...
{ WindowProperty_AirflowControlFields::AirflowReturnAirNodeName, "AirflowReturnAirNodeName", "Airflow Return Air Node Name"},
        { 0,0,0 }
      };
      VecType v;
      int i = 0;
