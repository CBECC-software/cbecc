...
Name,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<Refrigeration_TransferLoadListFields>::integer_value()); }
   private:
...
CascadeCondenserNameorSecondarySystemName,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<Refrigeration_TransferLoadListExtensibleFields>::integer_value()); }
   private:
