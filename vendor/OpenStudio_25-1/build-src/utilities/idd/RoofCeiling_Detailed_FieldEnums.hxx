...
Name, ConstructionName, ZoneName, SpaceName, OutsideBoundaryCondition, OutsideBoundaryConditionObject, SunExposure, WindExposure, ViewFactortoGround, NumberofVertices,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<RoofCeiling_DetailedFields>::integer_value()); }
   private:
...
VertexXcoordinate, VertexYcoordinate, VertexZcoordinate,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<RoofCeiling_DetailedExtensibleFields>::integer_value()); }
   private:
