...
class AirTerminal_SingleDuct_SeriesPIU_ReheatFields: public ::EnumBase<AirTerminal_SingleDuct_SeriesPIU_ReheatFields> {
 public: 
  enum domain 
  {
Name, AvailabilityScheduleName, MaximumAirFlowRate, MaximumPrimaryAirFlowRate, MinimumPrimaryAirFlowFraction, SupplyAirInletNodeName, SecondaryAirInletNodeName, OutletNodeName, ReheatCoilAirInletNodeName, ZoneMixerName, FanName, ReheatCoilObjectType, ReheatCoilName, MaximumHotWaterorSteamFlowRate, MinimumHotWaterorSteamFlowRate, ConvergenceTolerance, FanControlType, MinimumFanTurnDownRatio, HeatingControlType, DesignHeatingDischargeAirTemperature, HighLimitHeatingDischargeAirTemperature,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<AirTerminal_SingleDuct_SeriesPIU_ReheatFields>::integer_value()); }
   private:
...
{ AirTerminal_SingleDuct_SeriesPIU_ReheatFields::FanControlType, "FanControlType", "Fan Control Type"},
{ AirTerminal_SingleDuct_SeriesPIU_ReheatFields::MinimumFanTurnDownRatio, "MinimumFanTurnDownRatio", "Minimum Fan Turn Down Ratio"},
{ AirTerminal_SingleDuct_SeriesPIU_ReheatFields::HeatingControlType, "HeatingControlType", "Heating Control Type"},
{ AirTerminal_SingleDuct_SeriesPIU_ReheatFields::DesignHeatingDischargeAirTemperature, "DesignHeatingDischargeAirTemperature", "Design Heating Discharge Air Temperature"},
{ AirTerminal_SingleDuct_SeriesPIU_ReheatFields::HighLimitHeatingDischargeAirTemperature, "HighLimitHeatingDischargeAirTemperature", "High Limit Heating Discharge Air Temperature"},
        { 0,0,0 }
      };
      VecType v;
      int i = 0;
