...
class Coil_Heating_Electric_MultiStageFields: public ::EnumBase<Coil_Heating_Electric_MultiStageFields> {
 public: 
  enum domain 
  {
Name, AvailabilityScheduleName, AirInletNodeName, AirOutletNodeName, TemperatureSetpointNodeName, NumberofStages,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<Coil_Heating_Electric_MultiStageFields>::integer_value()); }
   private:
...
/** \class Coil_Heating_Electric_MultiStageExtensibleFields
 *  \brief Enumeration of Coil:Heating:Electric:MultiStage's Idd and Idf extensible fields
 ...
 *  \endcode */
#ifdef SWIG 
  OPENSTUDIO_ENUM(Coil_Heating_Electric_MultiStageExtensibleFields, )
#else
class Coil_Heating_Electric_MultiStageExtensibleFields: public ::EnumBase<Coil_Heating_Electric_MultiStageExtensibleFields> {
 public: 
  enum domain 
  {
StageEfficiency, StageNominalCapacity,   };
  Coil_Heating_Electric_MultiStageExtensibleFields()
   : EnumBase<Coil_Heating_Electric_MultiStageExtensibleFields>(StageEfficiency) {} 
  Coil_Heating_Electric_MultiStageExtensibleFields(const std::string &t_name) 
   : EnumBase<Coil_Heating_Electric_MultiStageExtensibleFields>(t_name) {} 
  Coil_Heating_Electric_MultiStageExtensibleFields(int t_value) 
   : EnumBase<Coil_Heating_Electric_MultiStageExtensibleFields>(t_value) {} 
  static std::string enumName() 
  { return "Coil_Heating_Electric_MultiStageExtensibleFields"; }
  domain value() const { return static_cast<domain>(EnumBase<Coil_Heating_Electric_MultiStageExtensibleFields>::integer_value()); }
   private:
    friend class EnumBase<Coil_Heating_Electric_MultiStageExtensibleFields>;
    typedef std::pair<std::string, int> PT;
    typedef std::vector<PT> VecType;
    static VecType buildStringVec(bool isd)
    {
      ...
      const evalue a[] =
      {
{ Coil_Heating_Electric_MultiStageExtensibleFields::StageEfficiency, "StageEfficiency", "Stage Efficiency"},
{ Coil_Heating_Electric_MultiStageExtensibleFields::StageNominalCapacity, "StageNominalCapacity", "Stage Nominal Capacity"},
        { 0,0,0 }
      };
      VecType v;
      int i = 0;
  ...
  inline std::ostream &operator<<(std::ostream &os, const Coil_Heating_Electric_MultiStageExtensibleFields &e)
  {
    return os << e.valueName() << "(" << e.value() << ")";
  }
  typedef boost::optional<Coil_Heating_Electric_MultiStageExtensibleFields> OptionalCoil_Heating_Electric_MultiStageExtensibleFields ;
#endif
