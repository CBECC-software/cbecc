...
Name, ZoneorSpaceName, ScheduleName, DesignFlowRateCalculationMethod, DesignFlowRate, FlowRateperFloorArea, FlowRateperPerson, AirChangesperHour, SourceZoneorSpaceName, DeltaTemperature, DeltaTemperatureScheduleName, MinimumReceivingTemperatureScheduleName, MaximumReceivingTemperatureScheduleName, MinimumSourceTemperatureScheduleName, MaximumSourceTemperatureScheduleName, MinimumOutdoorTemperatureScheduleName, MaximumOutdoorTemperatureScheduleName,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<ZoneMixingFields>::integer_value()); }
   private:
...
{ ZoneMixingFields::ZoneorSpaceName, "ZoneorSpaceName", "Zone or Space Name"},
...
{ ZoneMixingFields::FlowRateperFloorArea, "FlowRateperFloorArea", "Flow Rate per Floor Area"},
...
{ ZoneMixingFields::SourceZoneorSpaceName, "SourceZoneorSpaceName", "Source Zone or Space Name"},
...
{ ZoneMixingFields::MinimumReceivingTemperatureScheduleName, "MinimumReceivingTemperatureScheduleName", "Minimum Receiving Temperature Schedule Name"},
{ ZoneMixingFields::MaximumReceivingTemperatureScheduleName, "MaximumReceivingTemperatureScheduleName", "Maximum Receiving Temperature Schedule Name"},
{ ZoneMixingFields::MinimumSourceTemperatureScheduleName, "MinimumSourceTemperatureScheduleName", "Minimum Source Temperature Schedule Name"},
{ ZoneMixingFields::MaximumSourceTemperatureScheduleName, "MaximumSourceTemperatureScheduleName", "Maximum Source Temperature Schedule Name"},
