...
Handle, Name, OutletNodeName,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<OS_AirLoopHVAC_ZoneMixerFields>::integer_value()); }
   private:
...
InletNodeName,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<OS_AirLoopHVAC_ZoneMixerExtensibleFields>::integer_value()); }
   private:
