...
Name,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<PlantEquipmentOperation_HeatingLoadFields>::integer_value()); }
   private:
...
LoadRangeLowerLimit, LoadRangeUpperLimit, RangeEquipmentListName,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<PlantEquipmentOperation_HeatingLoadExtensibleFields>::integer_value()); }
   private:
