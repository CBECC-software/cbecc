...
Handle, Name, InletNodeName,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<OS_SplitterFields>::integer_value()); }
   private:
...
OutletNodeName,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<OS_SplitterExtensibleFields>::integer_value()); }
   private:
