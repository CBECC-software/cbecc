...
Handle, Name, TariffName,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<OS_UtilityCost_ComputationFields>::integer_value()); }
   private:
...
ComputeStep,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<OS_UtilityCost_ComputationExtensibleFields>::integer_value()); }
   private:
