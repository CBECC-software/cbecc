...
Name, AvailabilityScheduleName, NominalSupplyAirFlowRate, SensibleEffectivenessat100_HeatingAirFlow, LatentEffectivenessat100_HeatingAirFlow, SensibleEffectivenessat100_CoolingAirFlow, LatentEffectivenessat100_CoolingAirFlow, SupplyAirInletNodeName, SupplyAirOutletNodeName, ExhaustAirInletNodeName, ExhaustAirOutletNodeName, NominalElectricPower, SupplyAirOutletTemperatureControl, HeatExchangerType, FrostControlType, ThresholdTemperature, InitialDefrostTimeFraction, RateofDefrostTimeFractionIncrease, EconomizerLockout, SensibleEffectivenessofHeatingAirFlowCurveName, LatentEffectivenessofHeatingAirFlowCurveName, SensibleEffectivenessofCoolingAirFlowCurveName, LatentEffectivenessofCoolingAirFlowCurveName,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<HeatExchanger_AirToAir_SensibleAndLatentFields>::integer_value()); }
   private:
...
{ HeatExchanger_AirToAir_SensibleAndLatentFields::SensibleEffectivenessofHeatingAirFlowCurveName, "SensibleEffectivenessofHeatingAirFlowCurveName", "Sensible Effectiveness of Heating Air Flow Curve Name"},
{ HeatExchanger_AirToAir_SensibleAndLatentFields::LatentEffectivenessofHeatingAirFlowCurveName, "LatentEffectivenessofHeatingAirFlowCurveName", "Latent Effectiveness of Heating Air Flow Curve Name"},
{ HeatExchanger_AirToAir_SensibleAndLatentFields::SensibleEffectivenessofCoolingAirFlowCurveName, "SensibleEffectivenessofCoolingAirFlowCurveName", "Sensible Effectiveness of Cooling Air Flow Curve Name"},
{ HeatExchanger_AirToAir_SensibleAndLatentFields::LatentEffectivenessofCoolingAirFlowCurveName, "LatentEffectivenessofCoolingAirFlowCurveName", "Latent Effectiveness of Cooling Air Flow Curve Name"},
        { 0,0,0 }
      };
      VecType v;
      int i = 0;
