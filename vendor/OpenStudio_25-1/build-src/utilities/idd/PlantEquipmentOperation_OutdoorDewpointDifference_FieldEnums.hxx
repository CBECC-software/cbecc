...
Name, ReferenceTemperatureNodeName,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<PlantEquipmentOperation_OutdoorDewpointDifferenceFields>::integer_value()); }
   private:
...
DewpointTemperatureDifferenceRangeLowerLimit, DewpointTemperatureDifferenceRangeUpperLimit, RangeEquipmentListName,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<PlantEquipmentOperation_OutdoorDewpointDifferenceExtensibleFields>::integer_value()); }
   private:
