...
Handle, Name, AvailabilitySchedule, AirInletNodeName, AirOutletNodeName, CrankcaseHeaterCapacity, CrankcaseHeaterCapacityFunctionofTemperatureCurveName, MaximumOutdoorDryBulbTemperatureforCrankcaseHeaterOperation, NumberofCapacityStages, NumberofEnhancedDehumidificationModes, NormalModeStage1CoilPerformance, NormalModeStage1Plus2CoilPerformance, DehumidificationMode1Stage1CoilPerformance, DehumidificationMode1Stage1Plus2CoilPerformance, SupplyWaterStorageTank, CondensateCollectionWaterStorageTank, MinimumOutdoorDryBulbTemperatureforCompressorOperation, BasinHeaterCapacity, BasinHeaterSetpointTemperature, BasinHeaterOperatingSchedule,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<OS_Coil_Cooling_DX_TwoStageWithHumidityControlModeFields>::integer_value()); }
   private:
...
{ OS_Coil_Cooling_DX_TwoStageWithHumidityControlModeFields::CrankcaseHeaterCapacityFunctionofTemperatureCurveName, "CrankcaseHeaterCapacityFunctionofTemperatureCurveName", "Crankcase Heater Capacity Function of Temperature Curve Name"},
...
{ OS_Coil_Cooling_DX_TwoStageWithHumidityControlModeFields::MinimumOutdoorDryBulbTemperatureforCompressorOperation, "MinimumOutdoorDryBulbTemperatureforCompressorOperation", "Minimum Outdoor Dry-Bulb Temperature for Compressor Operation"},
