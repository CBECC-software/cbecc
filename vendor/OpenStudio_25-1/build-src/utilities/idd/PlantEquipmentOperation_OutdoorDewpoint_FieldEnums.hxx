...
Name,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<PlantEquipmentOperation_OutdoorDewpointFields>::integer_value()); }
   private:
...
DewpointTemperatureRangeLowerLimit, DewpointTemperatureRangeUpperLimit, RangeEquipmentListName,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<PlantEquipmentOperation_OutdoorDewpointExtensibleFields>::integer_value()); }
   private:
