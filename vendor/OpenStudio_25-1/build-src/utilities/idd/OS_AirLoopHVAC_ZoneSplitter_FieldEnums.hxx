...
Handle, Name, InletNodeName,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<OS_AirLoopHVAC_ZoneSplitterFields>::integer_value()); }
   private:
...
OutletNodeName,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<OS_AirLoopHVAC_ZoneSplitterExtensibleFields>::integer_value()); }
   private:
