...
class Coil_Heating_Gas_MultiStageFields: public ::EnumBase<Coil_Heating_Gas_MultiStageFields> {
 public: 
  enum domain 
  {
Name, AvailabilityScheduleName, AirInletNodeName, AirOutletNodeName, TemperatureSetpointNodeName, PartLoadFractionCorrelationCurveName, OffCycleParasiticGasLoad, NumberofStages,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<Coil_Heating_Gas_MultiStageFields>::integer_value()); }
   private:
...
{ Coil_Heating_Gas_MultiStageFields::OffCycleParasiticGasLoad, "OffCycleParasiticGasLoad", "Off Cycle Parasitic Gas Load"},
...
class Coil_Heating_Gas_MultiStageExtensibleFields: public ::EnumBase<Coil_Heating_Gas_MultiStageExtensibleFields> {
 public: 
  enum domain 
  {
StageGasBurnerEfficiency, StageNominalCapacity, StageOnCycleParasiticElectricLoad,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<Coil_Heating_Gas_MultiStageExtensibleFields>::integer_value()); }
   private:
...
{ Coil_Heating_Gas_MultiStageExtensibleFields::StageOnCycleParasiticElectricLoad, "StageOnCycleParasiticElectricLoad", "Stage On Cycle Parasitic Electric Load"},
        { 0,0,0 }
      };
      VecType v;
      int i = 0;
