...
class ZoneControl_ContaminantControllerFields: public ::EnumBase<ZoneControl_ContaminantControllerFields> {
 public: 
  enum domain 
  {
Name, ZoneName, CarbonDioxideControlAvailabilityScheduleName, CarbonDioxideSetpointScheduleName, MinimumCarbonDioxideConcentrationScheduleName, MaximumCarbonDioxideConcentrationScheduleName, GenericContaminantControlAvailabilityScheduleName, GenericContaminantSetpointScheduleName,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<ZoneControl_ContaminantControllerFields>::integer_value()); }
   private:
...
{ ZoneControl_ContaminantControllerFields::ZoneName, "ZoneName", "Zone Name"},
...
{ ZoneControl_ContaminantControllerFields::MaximumCarbonDioxideConcentrationScheduleName, "MaximumCarbonDioxideConcentrationScheduleName", "Maximum Carbon Dioxide Concentration Schedule Name"},
