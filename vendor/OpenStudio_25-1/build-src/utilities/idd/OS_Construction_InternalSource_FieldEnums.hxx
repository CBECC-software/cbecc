...
Handle, Name, SourcePresentAfterLayerNumber, TemperatureCalculationRequestedAfterLayerNumber, DimensionsfortheCTFCalculation, TubeSpacing, TwoDimensionalTemperatureCalculationPosition, SurfaceRenderingName,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<OS_Construction_InternalSourceFields>::integer_value()); }
   private:
...
Layer,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<OS_Construction_InternalSourceExtensibleFields>::integer_value()); }
   private:
