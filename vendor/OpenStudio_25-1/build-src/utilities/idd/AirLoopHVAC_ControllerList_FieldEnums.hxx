...
Name,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<AirLoopHVAC_ControllerListFields>::integer_value()); }
   private:
...
ControllerObjectType, ControllerName,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<AirLoopHVAC_ControllerListExtensibleFields>::integer_value()); }
   private:
