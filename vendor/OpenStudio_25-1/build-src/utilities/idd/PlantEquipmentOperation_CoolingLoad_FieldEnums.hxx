...
Name,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<PlantEquipmentOperation_CoolingLoadFields>::integer_value()); }
   private:
...
LoadRangeLowerLimit, LoadRangeUpperLimit, RangeEquipmentListName,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<PlantEquipmentOperation_CoolingLoadExtensibleFields>::integer_value()); }
   private:
