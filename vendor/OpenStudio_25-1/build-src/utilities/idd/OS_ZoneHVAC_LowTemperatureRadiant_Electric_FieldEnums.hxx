...
class OS_ZoneHVAC_LowTemperatureRadiant_ElectricFields: public ::EnumBase<OS_ZoneHVAC_LowTemperatureRadiant_ElectricFields> {
 public: 
  enum domain 
  {
Handle, Name, AvailabilityScheduleName, RadiantSurfaceType, MaximumElectricalPowertoPanel, TemperatureControlType, SetpointControlType, HeatingThrottlingRange, HeatingSetpointTemperatureScheduleName,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<OS_ZoneHVAC_LowTemperatureRadiant_ElectricFields>::integer_value()); }
   private:
...
{ OS_ZoneHVAC_LowTemperatureRadiant_ElectricFields::SetpointControlType, "SetpointControlType", "Setpoint Control Type"},
