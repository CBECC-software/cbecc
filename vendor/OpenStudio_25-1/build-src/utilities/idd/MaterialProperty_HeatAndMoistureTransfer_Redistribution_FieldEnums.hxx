...
MaterialName, NumberofRedistributionpoints,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<MaterialProperty_HeatAndMoistureTransfer_RedistributionFields>::integer_value()); }
   private:
...
MoistureContent, LiquidTransportCoefficient,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<MaterialProperty_HeatAndMoistureTransfer_RedistributionExtensibleFields>::integer_value()); }
   private:
