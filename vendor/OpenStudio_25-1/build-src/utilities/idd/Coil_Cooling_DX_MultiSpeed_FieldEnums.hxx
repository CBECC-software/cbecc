...
Name, AvailabilityScheduleName, AirInletNodeName, AirOutletNodeName, CondenserAirInletNodeName, CondenserType, MinimumOutdoorDryBulbTemperatureforCompressorOperation, SupplyWaterStorageTankName, CondensateCollectionWaterStorageTankName, ApplyPartLoadFractiontoSpeedsGreaterthan1, ApplyLatentDegradationtoSpeedsGreaterthan1, CrankcaseHeaterCapacity, CrankcaseHeaterCapacityFunctionofTemperatureCurveName, MaximumOutdoorDryBulbTemperatureforCrankcaseHeaterOperation, BasinHeaterCapacity, BasinHeaterSetpointTemperature, BasinHeaterOperatingScheduleName, FuelType, NumberofSpeeds,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<Coil_Cooling_DX_MultiSpeedFields>::integer_value()); }
   private:
...
{ Coil_Cooling_DX_MultiSpeedFields::CrankcaseHeaterCapacityFunctionofTemperatureCurveName, "CrankcaseHeaterCapacityFunctionofTemperatureCurveName", "Crankcase Heater Capacity Function of Temperature Curve Name"},
...
SpeedGrossRatedTotalCoolingCapacity, SpeedGrossRatedSensibleHeatRatio, SpeedGrossRatedCoolingCOP, SpeedRatedAirFlowRate, SpeedRatedEvaporatorFanPowerPerVolumeFlowRate2017, SpeedRatedEvaporatorFanPowerPerVolumeFlowRate2023, SpeedTotalCoolingCapacityFunctionofTemperatureCurveName, SpeedTotalCoolingCapacityFunctionofFlowFractionCurveName, SpeedEnergyInputRatioFunctionofTemperatureCurveName, SpeedEnergyInputRatioFunctionofFlowFractionCurveName, SpeedPartLoadFractionCorrelationCurveName, SpeedNominalTimeforCondensateRemovaltoBegin, SpeedRatioofInitialMoistureEvaporationRateandSteadyStateLatentCapacity, SpeedMaximumCyclingRate, SpeedLatentCapacityTimeConstant, SpeedRatedWasteHeatFractionofPowerInput, SpeedWasteHeatFunctionofTemperatureCurveName, SpeedEvaporativeCondenserEffectiveness, SpeedEvaporativeCondenserAirFlowRate, SpeedRatedEvaporativeCondenserPumpPowerConsumption,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<Coil_Cooling_DX_MultiSpeedExtensibleFields>::integer_value()); }
   private:
...
{ Coil_Cooling_DX_MultiSpeedExtensibleFields::SpeedRatedEvaporatorFanPowerPerVolumeFlowRate2017, "SpeedRatedEvaporatorFanPowerPerVolumeFlowRate2017", "Speed Rated Evaporator Fan Power Per Volume Flow Rate 2017"},
{ Coil_Cooling_DX_MultiSpeedExtensibleFields::SpeedRatedEvaporatorFanPowerPerVolumeFlowRate2023, "SpeedRatedEvaporatorFanPowerPerVolumeFlowRate2023", "Speed Rated Evaporator Fan Power Per Volume Flow Rate 2023"},
