...
Name, TariffName,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<UtilityCost_ComputationFields>::integer_value()); }
   private:
...
ComputeStep,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<UtilityCost_ComputationExtensibleFields>::integer_value()); }
   private:
