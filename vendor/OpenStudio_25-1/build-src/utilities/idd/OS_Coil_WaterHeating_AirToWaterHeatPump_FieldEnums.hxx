...
class OS_Coil_WaterHeating_AirToWaterHeatPumpFields: public ::EnumBase<OS_Coil_WaterHeating_AirToWaterHeatPumpFields> {
 public: 
  enum domain 
  {
Handle, Name, RatedHeatingCapacity, RatedCOP, RatedSensibleHeatRatio, RatedEvaporatorInletAirDryBulbTemperature, RatedEvaporatorInletAirWetBulbTemperature, RatedCondenserInletWaterTemperature, RatedEvaporatorAirFlowRate, RatedCondenserWaterFlowRate, EvaporatorFanPowerIncludedinRatedCOP, CondenserPumpPowerIncludedinRatedCOP, CondenserPumpHeatIncludedinRatedHeatingCapacityandRatedCOP, CondenserWaterPumpPower, FractionofCondenserPumpHeattoWater, EvaporatorAirInletNodeName, EvaporatorAirOutletNodeName, CondenserWaterInletNode, CondenserWaterOutletNode, CrankcaseHeaterCapacity, CrankcaseHeaterCapacityFunctionofTemperatureCurveName, MaximumAmbientTemperatureforCrankcaseHeaterOperation, EvaporatorAirTemperatureTypeforCurveObjects, HeatingCapacityFunctionofTemperatureCurve, HeatingCapacityFunctionofAirFlowFractionCurve, HeatingCapacityFunctionofWaterFlowFractionCurve, HeatingCOPFunctionofTemperatureCurve, HeatingCOPFunctionofAirFlowFractionCurve, HeatingCOPFunctionofWaterFlowFractionCurve, PartLoadFractionCorrelationCurve,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<OS_Coil_WaterHeating_AirToWaterHeatPumpFields>::integer_value()); }
   private:
...
{ OS_Coil_WaterHeating_AirToWaterHeatPumpFields::CrankcaseHeaterCapacityFunctionofTemperatureCurveName, "CrankcaseHeaterCapacityFunctionofTemperatureCurveName", "Crankcase Heater Capacity Function of Temperature Curve Name"},
