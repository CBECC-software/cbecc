...
Name,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<Refrigeration_CaseAndWalkInListFields>::integer_value()); }
   private:
...
CaseorWalkInName,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<Refrigeration_CaseAndWalkInListExtensibleFields>::integer_value()); }
   private:
