...
Name, ZoneName, AvailabilityScheduleName, WidthoftheAbsorberWall, CrossSectionalAreaofAirChannelOutlet, DischargeCoefficient,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<ZoneThermalChimneyFields>::integer_value()); }
   private:
...
class ZoneThermalChimneyExtensibleFields: public ::EnumBase<ZoneThermalChimneyExtensibleFields> {
 public: 
  enum domain 
  {
ZoneorSpaceName, DistancefromTopofThermalChimneytoInlet, RelativeRatiosofAirFlowRatesPassingthroughInlet, CrossSectionalAreasofAirChannelInlet,   };
  ZoneThermalChimneyExtensibleFields()
   : EnumBase<ZoneThermalChimneyExtensibleFields>(ZoneorSpaceName) {} 
  ...
  domain value() const { return static_cast<domain>(EnumBase<ZoneThermalChimneyExtensibleFields>::integer_value()); }
   private:
    ...
    static VecType buildStringVec(bool isd)
    {
      ...
      const evalue a[] =
      {
{ ZoneThermalChimneyExtensibleFields::ZoneorSpaceName, "ZoneorSpaceName", "Zone or Space Name"},
...
{ ZoneThermalChimneyExtensibleFields::RelativeRatiosofAirFlowRatesPassingthroughInlet, "RelativeRatiosofAirFlowRatesPassingthroughInlet", "Relative Ratios of Air Flow Rates Passing through Inlet"},
