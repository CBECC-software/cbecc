...
Handle, Name, ThermalZone, OutletNode, InducedAirOutletPortList,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<OS_AirLoopHVAC_ReturnPlenumFields>::integer_value()); }
   private:
...
InletNode,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<OS_AirLoopHVAC_ReturnPlenumExtensibleFields>::integer_value()); }
   private:
