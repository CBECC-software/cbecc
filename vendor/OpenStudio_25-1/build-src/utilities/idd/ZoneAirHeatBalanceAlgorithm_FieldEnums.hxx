...
class ZoneAirHeatBalanceAlgorithmFields: public ::EnumBase<ZoneAirHeatBalanceAlgorithmFields> {
 public: 
  enum domain 
  {
Algorithm, DoSpaceHeatBalanceforSizing, DoSpaceHeatBalanceforSimulation,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<ZoneAirHeatBalanceAlgorithmFields>::integer_value()); }
   private:
...
{ ZoneAirHeatBalanceAlgorithmFields::DoSpaceHeatBalanceforSizing, "DoSpaceHeatBalanceforSizing", "Do Space Heat Balance for Sizing"},
{ ZoneAirHeatBalanceAlgorithmFields::DoSpaceHeatBalanceforSimulation, "DoSpaceHeatBalanceforSimulation", "Do Space Heat Balance for Simulation"},
        { 0,0,0 }
      };
      VecType v;
      int i = 0;
