...
class AvailabilityManager_HybridVentilationFields: public ::EnumBase<AvailabilityManager_HybridVentilationFields> {
 public: 
  enum domain 
  {
Name, HVACAirLoopName, ControlZoneName, VentilationControlModeScheduleName, UseWeatherFileRainIndicators, MaximumWindSpeed, MinimumOutdoorTemperature, MaximumOutdoorTemperature, MinimumOutdoorEnthalpy, MaximumOutdoorEnthalpy, MinimumOutdoorDewpoint, MaximumOutdoorDewpoint, MinimumOutdoorVentilationAirScheduleName, OpeningFactorFunctionofWindSpeedCurveName, AirflowNetworkControlTypeScheduleName, SimpleAirflowControlTypeScheduleName, ZoneVentilationObjectName, MinimumHVACOperationTime, MinimumVentilationTime,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<AvailabilityManager_HybridVentilationFields>::integer_value()); }
   private:
...
{ AvailabilityManager_HybridVentilationFields::ControlZoneName, "ControlZoneName", "Control Zone Name"},
...
{ AvailabilityManager_HybridVentilationFields::MinimumHVACOperationTime, "MinimumHVACOperationTime", "Minimum HVAC Operation Time"},
{ AvailabilityManager_HybridVentilationFields::MinimumVentilationTime, "MinimumVentilationTime", "Minimum Ventilation Time"},
        { 0,0,0 }
      };
      VecType v;
      int i = 0;
