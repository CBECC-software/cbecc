...
class OS_AirTerminal_SingleDuct_VAV_HeatAndCool_ReheatFields: public ::EnumBase<OS_AirTerminal_SingleDuct_VAV_HeatAndCool_ReheatFields> {
 public: 
  enum domain 
  {
Handle, Name, AvailabilitySchedule, DamperAirOutlet, AirInlet, MaximumAirFlowRate, ZoneMinimumAirFlowFraction, ReheatCoil, MaximumHotWaterorSteamFlowRate, MinimumHotWaterorSteamFlowRate, AirOutlet, ConvergenceTolerance, MaximumReheatAirTemperature, MinimumAirFlowTurndownScheduleName,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<OS_AirTerminal_SingleDuct_VAV_HeatAndCool_ReheatFields>::integer_value()); }
   private:
...
{ OS_AirTerminal_SingleDuct_VAV_HeatAndCool_ReheatFields::MinimumAirFlowTurndownScheduleName, "MinimumAirFlowTurndownScheduleName", "Minimum Air Flow Turndown Schedule Name"},
        { 0,0,0 }
      };
      VecType v;
      int i = 0;
