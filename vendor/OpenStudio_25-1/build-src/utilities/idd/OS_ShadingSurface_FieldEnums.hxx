...
Handle, Name, ConstructionName, ShadingSurfaceGroupName, TransmittanceScheduleName, NumberofVertices,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<OS_ShadingSurfaceFields>::integer_value()); }
   private:
...
VertexXcoordinate, VertexYcoordinate, VertexZcoordinate,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<OS_ShadingSurfaceExtensibleFields>::integer_value()); }
   private:
