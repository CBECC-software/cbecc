...
class OS_BuildingFields: public ::EnumBase<OS_BuildingFields> {
 public: 
  enum domain 
  {
Handle, Name, BuildingSectorType, NorthAxis, NominalFloortoFloorHeight, SpaceTypeName, DefaultConstructionSetName, DefaultScheduleSetName, StandardsNumberofStories, StandardsNumberofAboveGroundStories, StandardsTemplate, StandardsBuildingType, StandardsNumberofLivingUnits, Relocatable, NominalFloortoCeilingHeight,   };
  OS_BuildingFields()
  ...
  domain value() const { return static_cast<domain>(EnumBase<OS_BuildingFields>::integer_value()); }
   private:
...
{ OS_BuildingFields::StandardsTemplate, "StandardsTemplate", "Standards Template"},
