...
class OS_Coil_Cooling_DX_VariableSpeed_SpeedDataFields: public ::EnumBase<OS_Coil_Cooling_DX_VariableSpeed_SpeedDataFields> {
 public: 
  enum domain 
  {
Handle, Name, ReferenceUnitGrossRatedTotalCoolingCapacity, ReferenceUnitGrossRatedSensibleHeatRatio, ReferenceUnitGrossRatedCoolingCOP, ReferenceUnitRatedAirFlowRate, RatedEvaporatorFanPowerPerVolumeFlowRate2017, RatedEvaporatorFanPowerPerVolumeFlowRate2023, ReferenceUnitRatedCondenserAirFlowRate, ReferenceUnitRatedPadEffectivenessofEvapPrecooling, TotalCoolingCapacityFunctionofTemperatureCurveName, TotalCoolingCapacityFunctionofAirFlowFractionCurveName, EnergyInputRatioFunctionofTemperatureCurveName, EnergyInputRatioFunctionofAirFlowFractionCurveName,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<OS_Coil_Cooling_DX_VariableSpeed_SpeedDataFields>::integer_value()); }
   private:
...
{ OS_Coil_Cooling_DX_VariableSpeed_SpeedDataFields::RatedEvaporatorFanPowerPerVolumeFlowRate2017, "RatedEvaporatorFanPowerPerVolumeFlowRate2017", "Rated Evaporator Fan Power Per Volume Flow Rate 2017"},
{ OS_Coil_Cooling_DX_VariableSpeed_SpeedDataFields::RatedEvaporatorFanPowerPerVolumeFlowRate2023, "RatedEvaporatorFanPowerPerVolumeFlowRate2023", "Rated Evaporator Fan Power Per Volume Flow Rate 2023"},
