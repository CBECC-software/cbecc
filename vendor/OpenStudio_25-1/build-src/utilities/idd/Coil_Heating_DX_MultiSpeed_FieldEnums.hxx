...
Name, AvailabilityScheduleName, AirInletNodeName, AirOutletNodeName, MinimumOutdoorDryBulbTemperatureforCompressorOperation, OutdoorDryBulbTemperaturetoTurnOnCompressor, CrankcaseHeaterCapacity, CrankcaseHeaterCapacityFunctionofTemperatureCurveName, MaximumOutdoorDryBulbTemperatureforCrankcaseHeaterOperation, DefrostEnergyInputRatioFunctionofTemperatureCurveName, MaximumOutdoorDryBulbTemperatureforDefrostOperation, DefrostStrategy, DefrostControl, DefrostTimePeriodFraction, ResistiveDefrostHeaterCapacity, ApplyPartLoadFractiontoSpeedsGreaterthan1, FuelType, RegionnumberforCalculatingHSPF, NumberofSpeeds,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<Coil_Heating_DX_MultiSpeedFields>::integer_value()); }
   private:
...
{ Coil_Heating_DX_MultiSpeedFields::CrankcaseHeaterCapacityFunctionofTemperatureCurveName, "CrankcaseHeaterCapacityFunctionofTemperatureCurveName", "Crankcase Heater Capacity Function of Temperature Curve Name"},
...
SpeedGrossRatedHeatingCapacity, SpeedGrossRatedHeatingCOP, SpeedRatedAirFlowRate, SpeedRatedSupplyAirFanPowerPerVolumeFlowRate2017, SpeedRatedSupplyAirFanPowerPerVolumeFlowRate2023, SpeedHeatingCapacityFunctionofTemperatureCurveName, SpeedHeatingCapacityFunctionofFlowFractionCurveName, SpeedEnergyInputRatioFunctionofTemperatureCurveName, SpeedEnergyInputRatioFunctionofFlowFractionCurveName, SpeedPartLoadFractionCorrelationCurveName, SpeedRatedWasteHeatFractionofPowerInput, SpeedWasteHeatFunctionofTemperatureCurveName,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<Coil_Heating_DX_MultiSpeedExtensibleFields>::integer_value()); }
   private:
...
{ Coil_Heating_DX_MultiSpeedExtensibleFields::SpeedRatedSupplyAirFanPowerPerVolumeFlowRate2017, "SpeedRatedSupplyAirFanPowerPerVolumeFlowRate2017", "Speed Rated Supply Air Fan Power Per Volume Flow Rate 2017"},
{ Coil_Heating_DX_MultiSpeedExtensibleFields::SpeedRatedSupplyAirFanPowerPerVolumeFlowRate2023, "SpeedRatedSupplyAirFanPowerPerVolumeFlowRate2023", "Speed Rated Supply Air Fan Power Per Volume Flow Rate 2023"},
