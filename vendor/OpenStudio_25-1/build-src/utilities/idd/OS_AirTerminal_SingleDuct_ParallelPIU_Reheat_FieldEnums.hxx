...
class OS_AirTerminal_SingleDuct_ParallelPIU_ReheatFields: public ::EnumBase<OS_AirTerminal_SingleDuct_ParallelPIU_ReheatFields> {
 public: 
  enum domain 
  {
Handle, Name, AvailabilityScheduleName, MaximumPrimaryAirFlowRate, MaximumSecondaryAirFlowRate, MinimumPrimaryAirFlowFraction, FanOnFlowFraction, SupplyAirInletNodeName, SecondaryAirInletNodeName, OutletNodeName, ReheatCoilAirInletNodeName, ZoneMixerName, FanName, ReheatCoilName, MaximumHotWaterorSteamFlowRate, MinimumHotWaterorSteamFlowRate, ConvergenceTolerance, FanControlType, MinimumFanTurnDownRatio, HeatingControlType, DesignHeatingDischargeAirTemperature, HighLimitHeatingDischargeAirTemperature,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<OS_AirTerminal_SingleDuct_ParallelPIU_ReheatFields>::integer_value()); }
   private:
...
{ OS_AirTerminal_SingleDuct_ParallelPIU_ReheatFields::FanControlType, "FanControlType", "Fan Control Type"},
{ OS_AirTerminal_SingleDuct_ParallelPIU_ReheatFields::MinimumFanTurnDownRatio, "MinimumFanTurnDownRatio", "Minimum Fan Turn Down Ratio"},
{ OS_AirTerminal_SingleDuct_ParallelPIU_ReheatFields::HeatingControlType, "HeatingControlType", "Heating Control Type"},
{ OS_AirTerminal_SingleDuct_ParallelPIU_ReheatFields::DesignHeatingDischargeAirTemperature, "DesignHeatingDischargeAirTemperature", "Design Heating Discharge Air Temperature"},
{ OS_AirTerminal_SingleDuct_ParallelPIU_ReheatFields::HighLimitHeatingDischargeAirTemperature, "HighLimitHeatingDischargeAirTemperature", "High Limit Heating Discharge Air Temperature"},
        { 0,0,0 }
      };
      VecType v;
      int i = 0;
