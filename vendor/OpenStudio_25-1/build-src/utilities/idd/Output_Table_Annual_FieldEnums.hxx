...
Name, Filter, ScheduleName,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<Output_Table_AnnualFields>::integer_value()); }
   private:
...
VariableorMeterorEMSVariableorFieldName, AggregationTypeforVariableorMeter, DigitsAfterDecimal,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<Output_Table_AnnualExtensibleFields>::integer_value()); }
   private:
