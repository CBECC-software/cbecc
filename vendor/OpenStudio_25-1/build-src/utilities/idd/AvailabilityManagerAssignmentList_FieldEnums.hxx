...
Name,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<AvailabilityManagerAssignmentListFields>::integer_value()); }
   private:
...
AvailabilityManagerObjectType, AvailabilityManagerName,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<AvailabilityManagerAssignmentListExtensibleFields>::integer_value()); }
   private:
