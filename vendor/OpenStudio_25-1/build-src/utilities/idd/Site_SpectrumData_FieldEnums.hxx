...
Name, SpectrumDataType,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<Site_SpectrumDataFields>::integer_value()); }
   private:
...
Wavelength, Spectrum,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<Site_SpectrumDataExtensibleFields>::integer_value()); }
   private:
