...
Handle, Name, ScheduleTypeLimitsName,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<OS_Schedule_CompactFields>::integer_value()); }
   private:
...
Field,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<OS_Schedule_CompactExtensibleFields>::integer_value()); }
   private:
