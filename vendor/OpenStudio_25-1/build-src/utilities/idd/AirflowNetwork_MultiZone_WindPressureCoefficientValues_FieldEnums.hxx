...
Name, AirflowNetwork_MultiZone_WindPressureCoefficientArrayName,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<AirflowNetwork_MultiZone_WindPressureCoefficientValuesFields>::integer_value()); }
   private:
...
WindPressureCoefficientValue,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<AirflowNetwork_MultiZone_WindPressureCoefficientValuesExtensibleFields>::integer_value()); }
   private:
