...
Name, Resource,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<LifeCycleCost_UseAdjustmentFields>::integer_value()); }
   private:
...
YearMultiplier,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<LifeCycleCost_UseAdjustmentExtensibleFields>::integer_value()); }
   private:
