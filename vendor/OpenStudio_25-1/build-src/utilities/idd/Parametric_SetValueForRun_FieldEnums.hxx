...
Name,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<Parametric_SetValueForRunFields>::integer_value()); }
   private:
...
ValueforRun,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<Parametric_SetValueForRunExtensibleFields>::integer_value()); }
   private:
