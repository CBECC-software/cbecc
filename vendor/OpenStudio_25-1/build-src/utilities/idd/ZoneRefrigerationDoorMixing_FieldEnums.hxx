...
class ZoneRefrigerationDoorMixingFields: public ::EnumBase<ZoneRefrigerationDoorMixingFields> {
 public: 
  enum domain 
  {
Name, ZoneorSpaceName1, ZoneorSpaceName2, ScheduleName, DoorHeight, DoorArea, DoorProtectionType,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<ZoneRefrigerationDoorMixingFields>::integer_value()); }
   private:
...
{ ZoneRefrigerationDoorMixingFields::ZoneorSpaceName1, "ZoneorSpaceName1", "Zone or Space Name 1"},
{ ZoneRefrigerationDoorMixingFields::ZoneorSpaceName2, "ZoneorSpaceName2", "Zone or Space Name 2"},
