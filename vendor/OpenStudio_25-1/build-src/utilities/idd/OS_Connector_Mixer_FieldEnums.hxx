...
Handle, Name, OutletBranchName,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<OS_Connector_MixerFields>::integer_value()); }
   private:
...
InletBranchName,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<OS_Connector_MixerExtensibleFields>::integer_value()); }
   private:
