...
Handle, Name, CIESkyModel, SnowIndicator, Month, DayofMonth,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<OS_LightingDesignDayFields>::integer_value()); }
   private:
...
HourtoSimulate, MinutetoSimulate,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<OS_LightingDesignDayExtensibleFields>::integer_value()); }
   private:
