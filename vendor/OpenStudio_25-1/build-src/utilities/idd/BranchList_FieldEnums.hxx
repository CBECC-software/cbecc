...
Name,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<BranchListFields>::integer_value()); }
   private:
...
BranchName,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<BranchListExtensibleFields>::integer_value()); }
   private:
