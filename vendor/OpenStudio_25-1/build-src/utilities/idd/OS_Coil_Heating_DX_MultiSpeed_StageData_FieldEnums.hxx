...
class OS_Coil_Heating_DX_MultiSpeed_StageDataFields: public ::EnumBase<OS_Coil_Heating_DX_MultiSpeed_StageDataFields> {
 public: 
  enum domain 
  {
Handle, Name, GrossRatedHeatingCapacity, GrossRatedHeatingCOP, RatedAirFlowRate, RatedSupplyAirFanPowerPerVolumeFlowRate2017, RatedSupplyAirFanPowerPerVolumeFlowRate2023, HeatingCapacityFunctionofTemperatureCurveName, HeatingCapacityFunctionofFlowFractionCurveName, EnergyInputRatioFunctionofTemperatureCurveName, EnergyInputRatioFunctionofFlowFractionCurveName, PartLoadFractionCorrelationCurveName, RatedWasteHeatFractionofPowerInput, WasteHeatFunctionofTemperatureCurveName,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<OS_Coil_Heating_DX_MultiSpeed_StageDataFields>::integer_value()); }
   private:
...
{ OS_Coil_Heating_DX_MultiSpeed_StageDataFields::Name, "Name", "Name"},
...
{ OS_Coil_Heating_DX_MultiSpeed_StageDataFields::RatedSupplyAirFanPowerPerVolumeFlowRate2017, "RatedSupplyAirFanPowerPerVolumeFlowRate2017", "Rated Supply Air Fan Power Per Volume Flow Rate 2017"},
{ OS_Coil_Heating_DX_MultiSpeed_StageDataFields::RatedSupplyAirFanPowerPerVolumeFlowRate2023, "RatedSupplyAirFanPowerPerVolumeFlowRate2023", "Rated Supply Air Fan Power Per Volume Flow Rate 2023"},
