...
class OS_Coil_Heating_Gas_MultiStageFields: public ::EnumBase<OS_Coil_Heating_Gas_MultiStageFields> {
 public: 
  enum domain 
  {
Handle, Name, AvailabilitySchedule, AirInletNode, AirOutletNode, PartLoadFractionCorrelationCurve, OffCycleParasiticGasLoad,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<OS_Coil_Heating_Gas_MultiStageFields>::integer_value()); }
   private:
...
{ OS_Coil_Heating_Gas_MultiStageFields::OffCycleParasiticGasLoad, "OffCycleParasiticGasLoad", "Off Cycle Parasitic Gas Load"},
        { 0,0,0 }
      };
      VecType v;
      int i = 0;
...
Stage,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<OS_Coil_Heating_Gas_MultiStageExtensibleFields>::integer_value()); }
   private:
