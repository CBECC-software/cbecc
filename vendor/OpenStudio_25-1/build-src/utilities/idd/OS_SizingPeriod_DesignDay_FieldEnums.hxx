...
class OS_SizingPeriod_DesignDayFields: public ::EnumBase<OS_SizingPeriod_DesignDayFields> {
 public: 
  enum domain 
  {
Handle, Name, MaximumDryBulbTemperature, DailyDryBulbTemperatureRange, BarometricPressure, WindSpeed, WindDirection, SkyClearness, RainIndicator, SnowIndicator, DayofMonth, Month, DayType, DaylightSavingTimeIndicator, HumidityConditionType, HumidityConditionDayScheduleName, WetbulborDewPointatMaximumDryBulb, HumidityRatioatMaximumDryBulb, EnthalpyatMaximumDryBulb, DryBulbTemperatureRangeModifierType, DryBulbTemperatureRangeModifierDayScheduleName, SolarModelIndicator, BeamSolarDayScheduleName, DiffuseSolarDayScheduleName, ASHRAEClearSkyOpticalDepthforBeamIrradiance, ASHRAEClearSkyOpticalDepthforDiffuseIrradiance, DailyWetBulbTemperatureRange, MaximumNumberWarmupDays, BeginEnvironmentResetMode,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<OS_SizingPeriod_DesignDayFields>::integer_value()); }
   private:
...
{ OS_SizingPeriod_DesignDayFields::HumidityConditionType, "HumidityConditionType", "Humidity Condition Type"},
{ OS_SizingPeriod_DesignDayFields::HumidityConditionDayScheduleName, "HumidityConditionDayScheduleName", "Humidity Condition Day Schedule Name"},
{ OS_SizingPeriod_DesignDayFields::WetbulborDewPointatMaximumDryBulb, "WetbulborDewPointatMaximumDryBulb", "Wetbulb or DewPoint at Maximum Dry-Bulb"},
{ OS_SizingPeriod_DesignDayFields::HumidityRatioatMaximumDryBulb, "HumidityRatioatMaximumDryBulb", "Humidity Ratio at Maximum Dry-Bulb"},
{ OS_SizingPeriod_DesignDayFields::EnthalpyatMaximumDryBulb, "EnthalpyatMaximumDryBulb", "Enthalpy at Maximum Dry-Bulb"},
...
{ OS_SizingPeriod_DesignDayFields::DryBulbTemperatureRangeModifierDayScheduleName, "DryBulbTemperatureRangeModifierDayScheduleName", "Dry-Bulb Temperature Range Modifier Day Schedule Name"},
...
{ OS_SizingPeriod_DesignDayFields::ASHRAEClearSkyOpticalDepthforBeamIrradiance, "ASHRAEClearSkyOpticalDepthforBeamIrradiance", "ASHRAE Clear Sky Optical Depth for Beam Irradiance"},
{ OS_SizingPeriod_DesignDayFields::ASHRAEClearSkyOpticalDepthforDiffuseIrradiance, "ASHRAEClearSkyOpticalDepthforDiffuseIrradiance", "ASHRAE Clear Sky Optical Depth for Diffuse Irradiance"},
...
{ OS_SizingPeriod_DesignDayFields::MaximumNumberWarmupDays, "MaximumNumberWarmupDays", "Maximum Number Warmup Days"},
{ OS_SizingPeriod_DesignDayFields::BeginEnvironmentResetMode, "BeginEnvironmentResetMode", "Begin Environment Reset Mode"},
        { 0,0,0 }
      };
      VecType v;
      int i = 0;
