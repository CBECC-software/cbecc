...
Name, DomeName, DiffuserName, ConstructionName, Diameter, TotalLength, EffectiveThermalResistance,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<DaylightingDevice_TubularFields>::integer_value()); }
   private:
...
TransitionZoneName, TransitionZoneLength,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<DaylightingDevice_TubularExtensibleFields>::integer_value()); }
   private:
