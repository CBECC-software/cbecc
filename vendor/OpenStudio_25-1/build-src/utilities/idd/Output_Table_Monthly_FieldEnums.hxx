...
Name, DigitsAfterDecimal,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<Output_Table_MonthlyFields>::integer_value()); }
   private:
...
VariableorMeterName, AggregationTypeforVariableorMeter,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<Output_Table_MonthlyExtensibleFields>::integer_value()); }
   private:
