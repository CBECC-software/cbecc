...
Handle, Name,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<OS_PlantEquipmentOperation_OutdoorWetBulbFields>::integer_value()); }
   private:
...
WetBulbTemperatureRangeLowerLimit, WetBulbTemperatureRangeUpperLimit, RangeEquipmentListName,   };
  OS_PlantEquipmentOperation_OutdoorWetBulbExtensibleFields()
   : EnumBase<OS_PlantEquipmentOperation_OutdoorWetBulbExtensibleFields>(WetBulbTemperatureRangeLowerLimit) {} 
  ...
  domain value() const { return static_cast<domain>(EnumBase<OS_PlantEquipmentOperation_OutdoorWetBulbExtensibleFields>::integer_value()); }
   private:
    ...
    static VecType buildStringVec(bool isd)
    {
      ...
      const evalue a[] =
      {
{ OS_PlantEquipmentOperation_OutdoorWetBulbExtensibleFields::WetBulbTemperatureRangeLowerLimit, "WetBulbTemperatureRangeLowerLimit", "Wet-Bulb Temperature Range Lower Limit"},
{ OS_PlantEquipmentOperation_OutdoorWetBulbExtensibleFields::WetBulbTemperatureRangeUpperLimit, "WetBulbTemperatureRangeUpperLimit", "Wet-Bulb Temperature Range Upper Limit"},
