...
Name, MeterName, DemandLimitScheduleName, DemandLimitSafetyFraction, BillingPeriodScheduleName, PeakPeriodScheduleName, DemandWindowLength, DemandManagerPriority,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<DemandManagerAssignmentListFields>::integer_value()); }
   private:
...
DemandManagerObjectType, DemandManagerName,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<DemandManagerAssignmentListExtensibleFields>::integer_value()); }
   private:
