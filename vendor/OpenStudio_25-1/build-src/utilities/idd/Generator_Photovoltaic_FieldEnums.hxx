...
class Generator_PhotovoltaicFields: public ::EnumBase<Generator_PhotovoltaicFields> {
 public: 
  enum domain 
  {
Name, SurfaceName, PhotovoltaicPerformanceObjectType, ModulePerformanceName, HeatTransferIntegrationMode, NumberofSeriesStringsinParallel, NumberofModulesinSeries,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<Generator_PhotovoltaicFields>::integer_value()); }
   private:
...
{ Generator_PhotovoltaicFields::NumberofSeriesStringsinParallel, "NumberofSeriesStringsinParallel", "Number of Series Strings in Parallel"},
