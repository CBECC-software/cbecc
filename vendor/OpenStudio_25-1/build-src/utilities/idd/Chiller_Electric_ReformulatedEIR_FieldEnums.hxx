...
Name, ReferenceCapacity, ReferenceCOP, ReferenceLeavingChilledWaterTemperature, ReferenceLeavingCondenserWaterTemperature, ReferenceChilledWaterFlowRate, ReferenceCondenserWaterFlowRate, CoolingCapacityFunctionofTemperatureCurveName, ElectricInputtoCoolingOutputRatioFunctionofTemperatureCurveName, ElectricInputtoCoolingOutputRatioFunctionofPartLoadRatioCurveType, ElectricInputtoCoolingOutputRatioFunctionofPartLoadRatioCurveName, MinimumPartLoadRatio, MaximumPartLoadRatio, OptimumPartLoadRatio, MinimumUnloadingRatio, ChilledWaterInletNodeName, ChilledWaterOutletNodeName, CondenserInletNodeName, CondenserOutletNodeName, FractionofCompressorElectricConsumptionRejectedbyCondenser, LeavingChilledWaterLowerTemperatureLimit, ChillerFlowModeType, DesignHeatRecoveryWaterFlowRate, HeatRecoveryInletNodeName, HeatRecoveryOutletNodeName, SizingFactor, CondenserHeatRecoveryRelativeCapacityFraction, HeatRecoveryInletHighTemperatureLimitScheduleName, HeatRecoveryLeavingTemperatureSetpointNodeName, EndUseSubcategory, CondenserFlowControl, CondenserLoopFlowRateFractionFunctionofLoopPartLoadRatioCurveName, TemperatureDifferenceAcrossCondenserScheduleName, CondenserMinimumFlowFraction, ThermosiphonCapacityFractionCurveName, ThermosiphonMinimumTemperatureDifference,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<Chiller_Electric_ReformulatedEIRFields>::integer_value()); }
   private:
...
{ Chiller_Electric_ReformulatedEIRFields::CondenserFlowControl, "CondenserFlowControl", "Condenser Flow Control"},
{ Chiller_Electric_ReformulatedEIRFields::CondenserLoopFlowRateFractionFunctionofLoopPartLoadRatioCurveName, "CondenserLoopFlowRateFractionFunctionofLoopPartLoadRatioCurveName", "Condenser Loop Flow Rate Fraction Function of Loop Part Load Ratio Curve Name"},
{ Chiller_Electric_ReformulatedEIRFields::TemperatureDifferenceAcrossCondenserScheduleName, "TemperatureDifferenceAcrossCondenserScheduleName", "Temperature Difference Across Condenser Schedule Name"},
{ Chiller_Electric_ReformulatedEIRFields::CondenserMinimumFlowFraction, "CondenserMinimumFlowFraction", "Condenser Minimum Flow Fraction"},
{ Chiller_Electric_ReformulatedEIRFields::ThermosiphonCapacityFractionCurveName, "ThermosiphonCapacityFractionCurveName", "Thermosiphon Capacity Fraction Curve Name"},
{ Chiller_Electric_ReformulatedEIRFields::ThermosiphonMinimumTemperatureDifference, "ThermosiphonMinimumTemperatureDifference", "Thermosiphon Minimum Temperature Difference"},
        { 0,0,0 }
      };
      VecType v;
      int i = 0;
