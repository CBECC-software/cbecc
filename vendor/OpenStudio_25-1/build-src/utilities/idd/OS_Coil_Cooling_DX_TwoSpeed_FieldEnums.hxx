...
Handle, Name, AvailabilityScheduleName, RatedHighSpeedTotalCoolingCapacity, RatedHighSpeedSensibleHeatRatio, RatedHighSpeedCOP, RatedHighSpeedAirFlowRate, RatedHighSpeedEvaporatorFanPowerPerVolumeFlowRate2017, RatedHighSpeedEvaporatorFanPowerPerVolumeFlowRate2023, UnitInternalStaticAirPressure, AirInletNodeName, AirOutletNodeName, TotalCoolingCapacityFunctionofTemperatureCurveName, TotalCoolingCapacityFunctionofFlowFractionCurveName, EnergyInputRatioFunctionofTemperatureCurveName, EnergyInputRatioFunctionofFlowFractionCurveName, PartLoadFractionCorrelationCurveName, RatedLowSpeedTotalCoolingCapacity, RatedLowSpeedSensibleHeatRatio, RatedLowSpeedCOP, RatedLowSpeedAirFlowRate, RatedLowSpeedEvaporatorFanPowerPerVolumeFlowRate2017, RatedLowSpeedEvaporatorFanPowerPerVolumeFlowRate2023, LowSpeedTotalCoolingCapacityFunctionofTemperatureCurveName, LowSpeedEnergyInputRatioFunctionofTemperatureCurveName, CondenserAirInletNodeName, CondenserType, MinimumOutdoorDryBulbTemperatureforCompressorOperation, HighSpeedEvaporativeCondenserEffectiveness, HighSpeedEvaporativeCondenserAirFlowRate, HighSpeedEvaporativeCondenserPumpRatedPowerConsumption, LowSpeedEvaporativeCondenserEffectiveness, LowSpeedEvaporativeCondenserAirFlowRate, LowSpeedEvaporativeCondenserPumpRatedPowerConsumption, SupplyWaterStorageTankName, CondensateCollectionWaterStorageTankName, BasinHeaterCapacity, BasinHeaterSetpointTemperature, BasinHeaterOperatingScheduleName,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<OS_Coil_Cooling_DX_TwoSpeedFields>::integer_value()); }
   private:
...
{ OS_Coil_Cooling_DX_TwoSpeedFields::RatedHighSpeedEvaporatorFanPowerPerVolumeFlowRate2017, "RatedHighSpeedEvaporatorFanPowerPerVolumeFlowRate2017", "Rated High Speed Evaporator Fan Power Per Volume Flow Rate 2017"},
{ OS_Coil_Cooling_DX_TwoSpeedFields::RatedHighSpeedEvaporatorFanPowerPerVolumeFlowRate2023, "RatedHighSpeedEvaporatorFanPowerPerVolumeFlowRate2023", "Rated High Speed Evaporator Fan Power Per Volume Flow Rate 2023"},
...
{ OS_Coil_Cooling_DX_TwoSpeedFields::RatedLowSpeedEvaporatorFanPowerPerVolumeFlowRate2017, "RatedLowSpeedEvaporatorFanPowerPerVolumeFlowRate2017", "Rated Low Speed Evaporator Fan Power Per Volume Flow Rate 2017"},
{ OS_Coil_Cooling_DX_TwoSpeedFields::RatedLowSpeedEvaporatorFanPowerPerVolumeFlowRate2023, "RatedLowSpeedEvaporatorFanPowerPerVolumeFlowRate2023", "Rated Low Speed Evaporator Fan Power Per Volume Flow Rate 2023"},
