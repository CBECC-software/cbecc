...
Handle, Name,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<OS_WindowMaterial_GlazingGroup_ThermochromicFields>::integer_value()); }
   private:
...
OpticalDataTemperature, WindowMaterialGlazingName,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<OS_WindowMaterial_GlazingGroup_ThermochromicExtensibleFields>::integer_value()); }
   private:
