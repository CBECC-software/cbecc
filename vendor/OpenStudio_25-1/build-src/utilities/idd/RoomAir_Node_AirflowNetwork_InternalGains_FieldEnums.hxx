...
Name,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<RoomAir_Node_AirflowNetwork_InternalGainsFields>::integer_value()); }
   private:
...
InternalGainObjectType, InternalGainObjectName, FractionofGainstoNode,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<RoomAir_Node_AirflowNetwork_InternalGainsExtensibleFields>::integer_value()); }
   private:
