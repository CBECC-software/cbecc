...
Name, MainModelProgramCallingManagerName, InitializationProgramCallingManagerName,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<PlantEquipmentOperation_UserDefinedFields>::integer_value()); }
   private:
...
EquipmentObjectType, EquipmentName,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<PlantEquipmentOperation_UserDefinedExtensibleFields>::integer_value()); }
   private:
