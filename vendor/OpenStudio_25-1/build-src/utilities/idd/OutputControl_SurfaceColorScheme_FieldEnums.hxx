...
Name,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<OutputControl_SurfaceColorSchemeFields>::integer_value()); }
   private:
...
DrawingElementType, ColorforDrawingElement,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<OutputControl_SurfaceColorSchemeExtensibleFields>::integer_value()); }
   private:
