...
Name, BaseSurfaceName, TransmittanceScheduleName, NumberofVertices,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<Shading_Zone_DetailedFields>::integer_value()); }
   private:
...
VertexXcoordinate, VertexYcoordinate, VertexZcoordinate,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<Shading_Zone_DetailedExtensibleFields>::integer_value()); }
   private:
