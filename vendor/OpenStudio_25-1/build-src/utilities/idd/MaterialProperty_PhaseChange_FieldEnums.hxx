...
Name, TemperatureCoefficientforThermalConductivity,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<MaterialProperty_PhaseChangeFields>::integer_value()); }
   private:
...
Temperature, Enthalpy,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<MaterialProperty_PhaseChangeExtensibleFields>::integer_value()); }
   private:
