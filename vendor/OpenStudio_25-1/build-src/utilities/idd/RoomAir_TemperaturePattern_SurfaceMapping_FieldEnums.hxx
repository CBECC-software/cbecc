...
Name, ControlIntegerforPatternControlScheduleName, ThermostatOffset, ReturnAirOffset, ExhaustAirOffset,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<RoomAir_TemperaturePattern_SurfaceMappingFields>::integer_value()); }
   private:
...
SurfaceNamePair, DeltaAdjacentAirTemperaturePair,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<RoomAir_TemperaturePattern_SurfaceMappingExtensibleFields>::integer_value()); }
   private:
