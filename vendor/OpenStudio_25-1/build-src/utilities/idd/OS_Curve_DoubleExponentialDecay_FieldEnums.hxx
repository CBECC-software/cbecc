...
Handle, Name, Coefficient1C1, Coefficient2C2, Coefficient3C3, Coefficient4C4, Coefficient5C5, MinimumValueofx, MaximumValueofx, MinimumCurveOutput, MaximumCurveOutput, InputUnitTypeforx, OutputUnitType,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<OS_Curve_DoubleExponentialDecayFields>::integer_value()); }
   private:
...
{ OS_Curve_DoubleExponentialDecayFields::Coefficient4C4, "Coefficient4C4", "Coefficient4 C4"},
{ OS_Curve_DoubleExponentialDecayFields::Coefficient5C5, "Coefficient5C5", "Coefficient5 C5"},
