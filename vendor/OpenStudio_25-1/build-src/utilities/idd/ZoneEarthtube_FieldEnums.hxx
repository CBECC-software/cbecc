...
ZoneName, ScheduleName, DesignFlowRate, MinimumZoneTemperaturewhenCooling, MaximumZoneTemperaturewhenHeating, DeltaTemperature, EarthtubeType, FanPressureRise, FanTotalEfficiency, PipeRadius, PipeThickness, PipeLength, PipeThermalConductivity, PipeDepthUnderGroundSurface, SoilCondition, AverageSoilSurfaceTemperature, AmplitudeofSoilSurfaceTemperature, PhaseConstantofSoilSurfaceTemperature, ConstantTermFlowCoefficient, TemperatureTermFlowCoefficient, VelocityTermFlowCoefficient, VelocitySquaredTermFlowCoefficient, EarthTubeModelType, EarthTubeModelParameters,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<ZoneEarthtubeFields>::integer_value()); }
   private:
...
{ ZoneEarthtubeFields::EarthTubeModelType, "EarthTubeModelType", "Earth Tube Model Type"},
{ ZoneEarthtubeFields::EarthTubeModelParameters, "EarthTubeModelParameters", "Earth Tube Model Parameters"},
        { 0,0,0 }
      };
      VecType v;
      int i = 0;
