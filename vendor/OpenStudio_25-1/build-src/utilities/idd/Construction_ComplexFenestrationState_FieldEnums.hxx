...
Name, BasisType, BasisSymmetryType, WindowThermalModel, BasisMatrixName, SolarOpticalComplexFrontTransmittanceMatrixName, SolarOpticalComplexBackReflectanceMatrixName, VisibleOpticalComplexFrontTransmittanceMatrixName, VisibleOpticalComplexBackTransmittanceMatrixName,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<Construction_ComplexFenestrationStateFields>::integer_value()); }
   private:
...
class Construction_ComplexFenestrationStateExtensibleFields: public ::EnumBase<Construction_ComplexFenestrationStateExtensibleFields> {
 public: 
  enum domain 
  {
OutsideLayerName, OutsideLayerDirectionalFrontAbsorptanceMatrixName, OutsideLayerDirectionalBackAbsorptanceMatrixName, GapName, CFSGapDirectionalFrontAbsorptanceMatrixName, CFSGapDirectionalBackAbsorptanceMatrixName,   };
  Construction_ComplexFenestrationStateExtensibleFields()
   : EnumBase<Construction_ComplexFenestrationStateExtensibleFields>(OutsideLayerName) {} 
  ...
  domain value() const { return static_cast<domain>(EnumBase<Construction_ComplexFenestrationStateExtensibleFields>::integer_value()); }
   private:
    ...
    static VecType buildStringVec(bool isd)
    {
      ...
      const evalue a[] =
      {
{ Construction_ComplexFenestrationStateExtensibleFields::OutsideLayerName, "OutsideLayerName", "Outside Layer Name"},
{ Construction_ComplexFenestrationStateExtensibleFields::OutsideLayerDirectionalFrontAbsorptanceMatrixName, "OutsideLayerDirectionalFrontAbsorptanceMatrixName", "Outside Layer Directional Front Absorptance Matrix Name"},
{ Construction_ComplexFenestrationStateExtensibleFields::OutsideLayerDirectionalBackAbsorptanceMatrixName, "OutsideLayerDirectionalBackAbsorptanceMatrixName", "Outside Layer Directional Back Absorptance Matrix Name"},
{ Construction_ComplexFenestrationStateExtensibleFields::GapName, "GapName", "Gap Name"},
{ Construction_ComplexFenestrationStateExtensibleFields::CFSGapDirectionalFrontAbsorptanceMatrixName, "CFSGapDirectionalFrontAbsorptanceMatrixName", "CFS Gap Directional Front Absorptance Matrix Name"},
{ Construction_ComplexFenestrationStateExtensibleFields::CFSGapDirectionalBackAbsorptanceMatrixName, "CFSGapDirectionalBackAbsorptanceMatrixName", "CFS Gap Directional Back Absorptance Matrix Name"},
        { 0,0,0 }
      };
      VecType v;
      int i = 0;
