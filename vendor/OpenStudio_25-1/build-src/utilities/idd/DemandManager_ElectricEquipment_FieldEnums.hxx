...
Name, AvailabilityScheduleName, LimitControl, MinimumLimitDuration, MaximumLimitFraction, LimitStepChange, SelectionControl, RotationDuration,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<DemandManager_ElectricEquipmentFields>::integer_value()); }
   private:
...
ElectricEquipmentName,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<DemandManager_ElectricEquipmentExtensibleFields>::integer_value()); }
   private:
