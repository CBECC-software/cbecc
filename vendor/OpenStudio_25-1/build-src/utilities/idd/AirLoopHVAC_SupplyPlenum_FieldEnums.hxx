...
Name, ZoneName, ZoneNodeName, InletNodeName,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<AirLoopHVAC_SupplyPlenumFields>::integer_value()); }
   private:
...
OutletNodeName,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<AirLoopHVAC_SupplyPlenumExtensibleFields>::integer_value()); }
   private:
