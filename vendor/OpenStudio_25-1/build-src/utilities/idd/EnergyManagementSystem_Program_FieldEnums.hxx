...
Name,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<EnergyManagementSystem_ProgramFields>::integer_value()); }
   private:
...
ProgramLine,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<EnergyManagementSystem_ProgramExtensibleFields>::integer_value()); }
   private:
