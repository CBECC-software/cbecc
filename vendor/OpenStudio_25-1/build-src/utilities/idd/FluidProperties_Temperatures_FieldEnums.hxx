...
Name,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<FluidProperties_TemperaturesFields>::integer_value()); }
   private:
...
Temperature,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<FluidProperties_TemperaturesExtensibleFields>::integer_value()); }
   private:
