...
Handle, Name, ReferenceTemperatureNodeName,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<OS_PlantEquipmentOperation_OutdoorDryBulbDifferenceFields>::integer_value()); }
   private:
...
DryBulbTemperatureDifferenceRangeLowerLimit, DryBulbTemperatureDifferenceRangeUpperLimit, RangeEquipmentListName,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<OS_PlantEquipmentOperation_OutdoorDryBulbDifferenceExtensibleFields>::integer_value()); }
   private:
