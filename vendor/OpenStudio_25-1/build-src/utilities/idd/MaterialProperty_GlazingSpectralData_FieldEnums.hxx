...
Name,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<MaterialProperty_GlazingSpectralDataFields>::integer_value()); }
   private:
...
Wavelength, Transmittance, FrontReflectance, BackReflectance,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<MaterialProperty_GlazingSpectralDataExtensibleFields>::integer_value()); }
   private:
