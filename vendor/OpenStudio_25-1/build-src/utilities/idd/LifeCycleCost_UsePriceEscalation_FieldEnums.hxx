...
Name, Resource, EscalationStartYear, EscalationStartMonth,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<LifeCycleCost_UsePriceEscalationFields>::integer_value()); }
   private:
...
YearEscalation,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<LifeCycleCost_UsePriceEscalationExtensibleFields>::integer_value()); }
   private:
