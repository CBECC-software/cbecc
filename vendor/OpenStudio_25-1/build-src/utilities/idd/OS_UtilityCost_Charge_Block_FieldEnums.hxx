...
Handle, Name, TariffName, SourceVariable, Season, CategoryVariableName, RemainingIntoVariable, BlockSizeMultiplierValueorVariableName,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<OS_UtilityCost_Charge_BlockFields>::integer_value()); }
   private:
...
BlockSizeValueorVariableName, BlockCostperUnitValueorVariableName,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<OS_UtilityCost_Charge_BlockExtensibleFields>::integer_value()); }
   private:
