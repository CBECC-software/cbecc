...
Name,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<AirflowNetwork_MultiZone_WindPressureCoefficientArrayFields>::integer_value()); }
   private:
...
WindDirection,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<AirflowNetwork_MultiZone_WindPressureCoefficientArrayExtensibleFields>::integer_value()); }
   private:
