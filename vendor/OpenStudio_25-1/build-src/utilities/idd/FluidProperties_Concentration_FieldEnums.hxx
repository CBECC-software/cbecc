...
FluidName, FluidPropertyType, TemperatureValuesName, Concentration,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<FluidProperties_ConcentrationFields>::integer_value()); }
   private:
...
PropertyValue,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<FluidProperties_ConcentrationExtensibleFields>::integer_value()); }
   private:
