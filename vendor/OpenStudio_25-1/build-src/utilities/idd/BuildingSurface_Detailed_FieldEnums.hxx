...
class BuildingSurface_DetailedFields: public ::EnumBase<BuildingSurface_DetailedFields> {
 public: 
  enum domain 
  {
Name, SurfaceType, ConstructionName, ZoneName, SpaceName, OutsideBoundaryCondition, OutsideBoundaryConditionObject, SunExposure, WindExposure, ViewFactortoGround, NumberofVertices,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<BuildingSurface_DetailedFields>::integer_value()); }
   private:
...
{ BuildingSurface_DetailedFields::SpaceName, "SpaceName", "Space Name"},
...
VertexXcoordinate, VertexYcoordinate, VertexZcoordinate,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<BuildingSurface_DetailedExtensibleFields>::integer_value()); }
   private:
