...
class OS_ZoneHVAC_LowTemperatureRadiant_VariableFlowFields: public ::EnumBase<OS_ZoneHVAC_LowTemperatureRadiant_VariableFlowFields> {
 public: 
  enum domain 
  {
Handle, Name, AvailabilityScheduleName, LowTempRadiantVariableFlowHeatingCoilName, LowTempRadiantVariableFlowCoolingCoilName, RadiantSurfaceType, FluidtoRadiantSurfaceHeatTransferModel, HydronicTubingInsideDiameter, HydronicTubingOutsideDiameter, HydronicTubingLength, HydronicTubingConductivity, TemperatureControlType, SetpointControlType, NumberofCircuits, CircuitLength, ChangeoverDelayTimePeriodSchedule,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<OS_ZoneHVAC_LowTemperatureRadiant_VariableFlowFields>::integer_value()); }
   private:
...
{ OS_ZoneHVAC_LowTemperatureRadiant_VariableFlowFields::FluidtoRadiantSurfaceHeatTransferModel, "FluidtoRadiantSurfaceHeatTransferModel", "Fluid to Radiant Surface Heat Transfer Model"},
...
{ OS_ZoneHVAC_LowTemperatureRadiant_VariableFlowFields::HydronicTubingOutsideDiameter, "HydronicTubingOutsideDiameter", "Hydronic Tubing Outside Diameter"},
{ OS_ZoneHVAC_LowTemperatureRadiant_VariableFlowFields::HydronicTubingLength, "HydronicTubingLength", "Hydronic Tubing Length"},
{ OS_ZoneHVAC_LowTemperatureRadiant_VariableFlowFields::HydronicTubingConductivity, "HydronicTubingConductivity", "Hydronic Tubing Conductivity"},
...
{ OS_ZoneHVAC_LowTemperatureRadiant_VariableFlowFields::SetpointControlType, "SetpointControlType", "Setpoint Control Type"},
...
{ OS_ZoneHVAC_LowTemperatureRadiant_VariableFlowFields::ChangeoverDelayTimePeriodSchedule, "ChangeoverDelayTimePeriodSchedule", "Changeover Delay Time Period Schedule"},
        { 0,0,0 }
      };
      VecType v;
      int i = 0;
