...
Name, CompressorType, RefrigerantType, DesignSourceSideFlowRate, NominalCoolingCoilCapacity, NominalTimeforCondensateRemovaltoBegin, RatioofInitialMoistureEvaporationRateandSteadyStateLatentCapacity, HighPressureCutoff, LowPressureCutoff, WaterInletNodeName, WaterOutletNodeName, AirInletNodeName, AirOutletNodeName, LoadSideTotalHeatTransferCoefficient, LoadSideOutsideSurfaceHeatTransferCoefficient, SuperheatTemperatureattheEvaporatorOutlet, CompressorPowerLosses, CompressorEfficiency, CompressorPistonDisplacement, CompressorSuction_DischargePressureDrop, CompressorClearanceFactor, RefrigerantVolumeFlowRate, VolumeRatio, LeakRateCoefficient, SourceSideHeatTransferCoefficient, SourceSideHeatTransferResistance1, SourceSideHeatTransferResistance2, PartLoadFractionCorrelationCurveName, MaximumCyclingRate, LatentCapacityTimeConstant, FanDelayTime,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<Coil_Cooling_WaterToAirHeatPump_ParameterEstimationFields>::integer_value()); }
   private:
...
{ Coil_Cooling_WaterToAirHeatPump_ParameterEstimationFields::PartLoadFractionCorrelationCurveName, "PartLoadFractionCorrelationCurveName", "Part Load Fraction Correlation Curve Name"},
{ Coil_Cooling_WaterToAirHeatPump_ParameterEstimationFields::MaximumCyclingRate, "MaximumCyclingRate", "Maximum Cycling Rate"},
{ Coil_Cooling_WaterToAirHeatPump_ParameterEstimationFields::LatentCapacityTimeConstant, "LatentCapacityTimeConstant", "Latent Capacity Time Constant"},
{ Coil_Cooling_WaterToAirHeatPump_ParameterEstimationFields::FanDelayTime, "FanDelayTime", "Fan Delay Time"},
        { 0,0,0 }
      };
      VecType v;
      int i = 0;
