...
Handle,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<OS_ClimateZonesFields>::integer_value()); }
   private:
...
ClimateZoneInstitutionName, ClimateZoneDocumentName, ClimateZoneDocumentYear, ClimateZoneValue,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<OS_ClimateZonesExtensibleFields>::integer_value()); }
   private:
