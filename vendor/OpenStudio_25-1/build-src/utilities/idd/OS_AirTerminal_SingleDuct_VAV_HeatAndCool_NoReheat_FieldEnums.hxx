...
class OS_AirTerminal_SingleDuct_VAV_HeatAndCool_NoReheatFields: public ::EnumBase<OS_AirTerminal_SingleDuct_VAV_HeatAndCool_NoReheatFields> {
 public: 
  enum domain 
  {
Handle, Name, AvailabilitySchedule, AirOutlet, AirInlet, MaximumAirFlowRate, ZoneMinimumAirFlowFraction, MinimumAirFlowTurndownScheduleName,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<OS_AirTerminal_SingleDuct_VAV_HeatAndCool_NoReheatFields>::integer_value()); }
   private:
...
{ OS_AirTerminal_SingleDuct_VAV_HeatAndCool_NoReheatFields::MinimumAirFlowTurndownScheduleName, "MinimumAirFlowTurndownScheduleName", "Minimum Air Flow Turndown Schedule Name"},
        { 0,0,0 }
      };
      VecType v;
      int i = 0;
