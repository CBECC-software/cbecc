...
Handle, Name, AvailabilitySchedule, DemandControlledVentilation, SystemOutdoorAirMethod,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<OS_Controller_MechanicalVentilationFields>::integer_value()); }
   private:
...
ThermalZone, DesignSpecificationOutdoorAirObject, DesignSpecificationZoneAirDistributionObject,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<OS_Controller_MechanicalVentilationExtensibleFields>::integer_value()); }
   private:
