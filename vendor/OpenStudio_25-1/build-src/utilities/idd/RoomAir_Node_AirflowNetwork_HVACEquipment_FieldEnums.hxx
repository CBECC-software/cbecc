...
Name,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<RoomAir_Node_AirflowNetwork_HVACEquipmentFields>::integer_value()); }
   private:
...
ZoneHVACorAirTerminalEquipmentObjectType, ZoneHVACorAirTerminalEquipmentObjectName, FractionofOutputorSupplyAirfromHVACEquipment, FractionofInputorReturnAirtoHVACEquipment,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<RoomAir_Node_AirflowNetwork_HVACEquipmentExtensibleFields>::integer_value()); }
   private:
