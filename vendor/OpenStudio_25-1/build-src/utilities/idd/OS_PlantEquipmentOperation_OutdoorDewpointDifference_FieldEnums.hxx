...
Handle, Name, ReferenceTemperatureNodeName,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<OS_PlantEquipmentOperation_OutdoorDewpointDifferenceFields>::integer_value()); }
   private:
...
DryBulbTemperatureDifferenceRangeLowerLimit, DryBulbTemperatureDifferenceRangeUpperLimit, RangeEquipmentListName,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<OS_PlantEquipmentOperation_OutdoorDewpointDifferenceExtensibleFields>::integer_value()); }
   private:
