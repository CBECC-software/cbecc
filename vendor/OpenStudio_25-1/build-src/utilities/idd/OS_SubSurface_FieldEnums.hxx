...
class OS_SubSurfaceFields: public ::EnumBase<OS_SubSurfaceFields> {
 public: 
  enum domain 
  {
Handle, Name, SubSurfaceType, ConstructionName, SurfaceName, OutsideBoundaryConditionObject, ViewFactortoGround, FrameandDividerName, Multiplier, NumberofVertices,   };
  OS_SubSurfaceFields()
  ...
  domain value() const { return static_cast<domain>(EnumBase<OS_SubSurfaceFields>::integer_value()); }
   private:
...
VertexXcoordinate, VertexYcoordinate, VertexZcoordinate,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<OS_SubSurfaceExtensibleFields>::integer_value()); }
   private:
