...
class OS_GroundHeatExchanger_VerticalFields: public ::EnumBase<OS_GroundHeatExchanger_VerticalFields> {
 public: 
  enum domain 
  {
Handle, Name, InletNodeName, OutletNodeName, DesignFlowRate, NumberofBoreHoles, BoreHoleTopDepth, BoreHoleLength, BoreHoleRadius, GroundThermalConductivity, GroundThermalHeatCapacity, GroundTemperature, GroutThermalConductivity, PipeThermalConductivity, PipeOutDiameter, UTubeDistance, PipeThickness, MaximumLengthofSimulation, UndisturbedGroundTemperatureModel, GFunctionReferenceRatio,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<OS_GroundHeatExchanger_VerticalFields>::integer_value()); }
   private:
...
{ OS_GroundHeatExchanger_VerticalFields::BoreHoleTopDepth, "BoreHoleTopDepth", "Bore Hole Top Depth"},
...
{ OS_GroundHeatExchanger_VerticalFields::UndisturbedGroundTemperatureModel, "UndisturbedGroundTemperatureModel", "Undisturbed Ground Temperature Model"},
...
GFunctionLn_T_Ts_Value, GFunctionGValue,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<OS_GroundHeatExchanger_VerticalExtensibleFields>::integer_value()); }
   private:
