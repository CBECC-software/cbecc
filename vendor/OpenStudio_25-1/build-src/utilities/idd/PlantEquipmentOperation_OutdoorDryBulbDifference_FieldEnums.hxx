...
Name, ReferenceTemperatureNodeName,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<PlantEquipmentOperation_OutdoorDryBulbDifferenceFields>::integer_value()); }
   private:
...
DryBulbTemperatureDifferenceRangeLowerLimit, DryBulbTemperatureDifferenceRangeUpperLimit, RangeEquipmentListName,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<PlantEquipmentOperation_OutdoorDryBulbDifferenceExtensibleFields>::integer_value()); }
   private:
