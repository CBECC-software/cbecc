...
Handle, Name, SourceSideInletNodeName, SourceSideOutletNodeName, LoadSideInletNodeName, LoadSideOutletNodeName, ReferenceLoadSideFlowRate, ReferenceSourceSideFlowRate, ReferenceHeatingCapacity, ReferenceHeatingPowerConsumption, HeatingCapacityCurveName, HeatingCompressorPowerCurveName, ReferenceCoefficientofPerformance, SizingFactor, CompanionCoolingHeatPumpName,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<OS_HeatPump_WaterToWater_EquationFit_HeatingFields>::integer_value()); }
   private:
...
{ OS_HeatPump_WaterToWater_EquationFit_HeatingFields::HeatingCapacityCurveName, "HeatingCapacityCurveName", "Heating Capacity Curve Name"},
{ OS_HeatPump_WaterToWater_EquationFit_HeatingFields::HeatingCompressorPowerCurveName, "HeatingCompressorPowerCurveName", "Heating Compressor Power Curve Name"},
