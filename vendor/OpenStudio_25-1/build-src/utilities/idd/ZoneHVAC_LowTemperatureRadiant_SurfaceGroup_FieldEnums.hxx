...
Name,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<ZoneHVAC_LowTemperatureRadiant_SurfaceGroupFields>::integer_value()); }
   private:
...
SurfaceName, FlowFractionforSurface,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<ZoneHVAC_LowTemperatureRadiant_SurfaceGroupExtensibleFields>::integer_value()); }
   private:
