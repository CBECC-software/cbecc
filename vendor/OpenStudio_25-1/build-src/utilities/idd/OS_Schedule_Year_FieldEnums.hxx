...
Handle, Name, ScheduleTypeLimitsName,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<OS_Schedule_YearFields>::integer_value()); }
   private:
...
Month, Day, WeekScheduleUntilDate,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<OS_Schedule_YearExtensibleFields>::integer_value()); }
   private:
