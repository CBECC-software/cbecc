...
Handle, Name, ControlledZone, VentilationControlModeSchedule, UseWeatherFileRainIndicators, MaximumWindSpeed, MinimumOutdoorTemperature, MaximumOutdoorTemperature, MinimumOutdoorEnthalpy, MaximumOutdoorEnthalpy, MinimumOutdoorDewpoint, MaximumOutdoorDewpoint, MinimumOutdoorVentilationAirSchedule, OpeningFactorFunctionofWindSpeedCurve, AirflowNetworkControlTypeSchedule, SimpleAirflowControlTypeSchedule, ZoneVentilationObject, MinimumHVACOperationTime, MinimumVentilationTime,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<OS_AvailabilityManager_HybridVentilationFields>::integer_value()); }
   private:
...
{ OS_AvailabilityManager_HybridVentilationFields::MinimumHVACOperationTime, "MinimumHVACOperationTime", "Minimum HVAC Operation Time"},
{ OS_AvailabilityManager_HybridVentilationFields::MinimumVentilationTime, "MinimumVentilationTime", "Minimum Ventilation Time"},
        { 0,0,0 }
      };
      VecType v;
      int i = 0;
