...
Name,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<AirLoopHVAC_OutdoorAirSystem_EquipmentListFields>::integer_value()); }
   private:
...
ComponentObjectType, ComponentName,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<AirLoopHVAC_OutdoorAirSystem_EquipmentListExtensibleFields>::integer_value()); }
   private:
