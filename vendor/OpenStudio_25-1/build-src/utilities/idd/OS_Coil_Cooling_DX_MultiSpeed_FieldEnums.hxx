...
Handle, Name, AvailabilitySchedule, AirInletNode, AirOutletNode, CondenserAirInletNode, CondenserType, MinimumOutdoorDryBulbTemperatureforCompressorOperation, SupplyWaterStorageTank, CondensateCollectionWaterStorageTank, ApplyPartLoadFractiontoSpeedsGreaterthan1, ApplyLatentDegradationtoSpeedsGreaterthan1, CrankcaseHeaterCapacity, CrankcaseHeaterCapacityFunctionofTemperatureCurveName, MaximumOutdoorDryBulbTemperatureforCrankcaseHeaterOperation, BasinHeaterCapacity, BasinHeaterSetpointTemperature, BasinHeaterOperatingSchedule, FuelType,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<OS_Coil_Cooling_DX_MultiSpeedFields>::integer_value()); }
   private:
...
{ OS_Coil_Cooling_DX_MultiSpeedFields::CrankcaseHeaterCapacityFunctionofTemperatureCurveName, "CrankcaseHeaterCapacityFunctionofTemperatureCurveName", "Crankcase Heater Capacity Function of Temperature Curve Name"},
...
Stage,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<OS_Coil_Cooling_DX_MultiSpeedExtensibleFields>::integer_value()); }
   private:
