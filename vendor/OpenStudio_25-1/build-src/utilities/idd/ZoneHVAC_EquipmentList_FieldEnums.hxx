...
Name, LoadDistributionScheme,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<ZoneHVAC_EquipmentListFields>::integer_value()); }
   private:
...
{ ZoneHVAC_EquipmentListFields::LoadDistributionScheme, "LoadDistributionScheme", "Load Distribution Scheme"},
        { 0,0,0 }
      };
      VecType v;
      int i = 0;
...
class ZoneHVAC_EquipmentListExtensibleFields: public ::EnumBase<ZoneHVAC_EquipmentListExtensibleFields> {
 public: 
  enum domain 
  {
ZoneEquipmentObjectType, ZoneEquipmentName, ZoneEquipmentCoolingSequence, ZoneEquipmentHeatingorNoLoadSequence, ZoneEquipmentSequentialCoolingFractionScheduleName, ZoneEquipmentSequentialHeatingFractionScheduleName,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<ZoneHVAC_EquipmentListExtensibleFields>::integer_value()); }
   private:
...
{ ZoneHVAC_EquipmentListExtensibleFields::ZoneEquipmentSequentialCoolingFractionScheduleName, "ZoneEquipmentSequentialCoolingFractionScheduleName", "Zone Equipment Sequential Cooling Fraction Schedule Name"},
{ ZoneHVAC_EquipmentListExtensibleFields::ZoneEquipmentSequentialHeatingFractionScheduleName, "ZoneEquipmentSequentialHeatingFractionScheduleName", "Zone Equipment Sequential Heating Fraction Schedule Name"},
        { 0,0,0 }
      };
      VecType v;
      int i = 0;
