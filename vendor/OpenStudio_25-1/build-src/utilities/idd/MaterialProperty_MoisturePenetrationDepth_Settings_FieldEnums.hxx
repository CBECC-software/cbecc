...
class MaterialProperty_MoisturePenetrationDepth_SettingsFields: public ::EnumBase<MaterialProperty_MoisturePenetrationDepth_SettingsFields> {
 public: 
  enum domain 
  {
Name, WaterVaporDiffusionResistanceFactor, MoistureEquationCoefficienta, MoistureEquationCoefficientb, MoistureEquationCoefficientc, MoistureEquationCoefficientd, SurfaceLayerPenetrationDepth, DeepLayerPenetrationDepth, CoatingLayerThickness, CoatingLayerWaterVaporDiffusionResistanceFactor,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<MaterialProperty_MoisturePenetrationDepth_SettingsFields>::integer_value()); }
   private:
...
{ MaterialProperty_MoisturePenetrationDepth_SettingsFields::WaterVaporDiffusionResistanceFactor, "WaterVaporDiffusionResistanceFactor", "Water Vapor Diffusion Resistance Factor"},
...
{ MaterialProperty_MoisturePenetrationDepth_SettingsFields::SurfaceLayerPenetrationDepth, "SurfaceLayerPenetrationDepth", "Surface Layer Penetration Depth"},
{ MaterialProperty_MoisturePenetrationDepth_SettingsFields::DeepLayerPenetrationDepth, "DeepLayerPenetrationDepth", "Deep Layer Penetration Depth"},
{ MaterialProperty_MoisturePenetrationDepth_SettingsFields::CoatingLayerThickness, "CoatingLayerThickness", "Coating Layer Thickness"},
{ MaterialProperty_MoisturePenetrationDepth_SettingsFields::CoatingLayerWaterVaporDiffusionResistanceFactor, "CoatingLayerWaterVaporDiffusionResistanceFactor", "Coating Layer Water Vapor Diffusion Resistance Factor"},
        { 0,0,0 }
      };
      VecType v;
      int i = 0;
