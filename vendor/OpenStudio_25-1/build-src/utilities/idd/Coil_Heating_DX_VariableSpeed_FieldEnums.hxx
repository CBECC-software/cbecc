...
Name, IndoorAirInletNodeName, IndoorAirOutletNodeName, NumberofSpeeds, NominalSpeedLevel, RatedHeatingCapacityAtSelectedNominalSpeedLevel, RatedAirFlowRateAtSelectedNominalSpeedLevel, EnergyPartLoadFractionCurveName, DefrostEnergyInputRatioFunctionofTemperatureCurveName, MinimumOutdoorDryBulbTemperatureforCompressorOperation, OutdoorDryBulbTemperaturetoTurnOnCompressor, MaximumOutdoorDryBulbTemperatureforDefrostOperation, CrankcaseHeaterCapacity, CrankcaseHeaterCapacityFunctionofTemperatureCurveName, MaximumOutdoorDryBulbTemperatureforCrankcaseHeaterOperation, DefrostStrategy, DefrostControl, DefrostTimePeriodFraction, ResistiveDefrostHeaterCapacity,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<Coil_Heating_DX_VariableSpeedFields>::integer_value()); }
   private:
...
{ Coil_Heating_DX_VariableSpeedFields::CrankcaseHeaterCapacityFunctionofTemperatureCurveName, "CrankcaseHeaterCapacityFunctionofTemperatureCurveName", "Crankcase Heater Capacity Function of Temperature Curve Name"},
...
class Coil_Heating_DX_VariableSpeedExtensibleFields: public ::EnumBase<Coil_Heating_DX_VariableSpeedExtensibleFields> {
 public: 
  enum domain 
  {
SpeedReferenceUnitGrossRatedHeatingCapacity, SpeedReferenceUnitGrossRatedHeatingCOP, SpeedReferenceUnitRatedAirFlowRate, SpeedRatedSupplyAirFanPowerPerVolumeFlowRate2017, SpeedRatedSupplyAirFanPowerPerVolumeFlowRate2023, SpeedHeatingCapacityFunctionofTemperatureCurveName, SpeedTotalHeatingCapacityFunctionofAirFlowFractionCurveName, SpeedEnergyInputRatioFunctionofTemperatureCurveName, SpeedEnergyInputRatioFunctionofAirFlowFractionCurveName,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<Coil_Heating_DX_VariableSpeedExtensibleFields>::integer_value()); }
   private:
...
{ Coil_Heating_DX_VariableSpeedExtensibleFields::SpeedRatedSupplyAirFanPowerPerVolumeFlowRate2017, "SpeedRatedSupplyAirFanPowerPerVolumeFlowRate2017", "Speed Rated Supply Air Fan Power Per Volume Flow Rate 2017"},
{ Coil_Heating_DX_VariableSpeedExtensibleFields::SpeedRatedSupplyAirFanPowerPerVolumeFlowRate2023, "SpeedRatedSupplyAirFanPowerPerVolumeFlowRate2023", "Speed Rated Supply Air Fan Power Per Volume Flow Rate 2023"},
