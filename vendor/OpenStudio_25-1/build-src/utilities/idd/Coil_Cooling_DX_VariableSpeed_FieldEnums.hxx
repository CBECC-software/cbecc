...
Name, IndoorAirInletNodeName, IndoorAirOutletNodeName, NumberofSpeeds, NominalSpeedLevel, GrossRatedTotalCoolingCapacityAtSelectedNominalSpeedLevel, RatedAirFlowRateAtSelectedNominalSpeedLevel, NominalTimeforCondensatetoBeginLeavingtheCoil, InitialMoistureEvaporationRateDividedbySteadyStateACLatentCapacity, MaximumCyclingRate, LatentCapacityTimeConstant, FanDelayTime, EnergyPartLoadFractionCurveName, CondenserAirInletNodeName, CondenserType, EvaporativeCondenserPumpRatedPowerConsumption, CrankcaseHeaterCapacity, CrankcaseHeaterCapacityFunctionofTemperatureCurveName, MaximumOutdoorDryBulbTemperatureforCrankcaseHeaterOperation, MinimumOutdoorDryBulbTemperatureforCompressorOperation, SupplyWaterStorageTankName, CondensateCollectionWaterStorageTankName, BasinHeaterCapacity, BasinHeaterSetpointTemperature, BasinHeaterOperatingScheduleName,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<Coil_Cooling_DX_VariableSpeedFields>::integer_value()); }
   private:
...
{ Coil_Cooling_DX_VariableSpeedFields::MaximumCyclingRate, "MaximumCyclingRate", "Maximum Cycling Rate"},
{ Coil_Cooling_DX_VariableSpeedFields::LatentCapacityTimeConstant, "LatentCapacityTimeConstant", "Latent Capacity Time Constant"},
{ Coil_Cooling_DX_VariableSpeedFields::FanDelayTime, "FanDelayTime", "Fan Delay Time"},
...
{ Coil_Cooling_DX_VariableSpeedFields::CrankcaseHeaterCapacityFunctionofTemperatureCurveName, "CrankcaseHeaterCapacityFunctionofTemperatureCurveName", "Crankcase Heater Capacity Function of Temperature Curve Name"},
...
class Coil_Cooling_DX_VariableSpeedExtensibleFields: public ::EnumBase<Coil_Cooling_DX_VariableSpeedExtensibleFields> {
 public: 
  enum domain 
  {
SpeedReferenceUnitGrossRatedTotalCoolingCapacity, SpeedReferenceUnitGrossRatedSensibleHeatRatio, SpeedReferenceUnitGrossRatedCoolingCOP, SpeedReferenceUnitRatedAirFlowRate, SpeedRatedEvaporatorFanPowerPerVolumeFlowRate2017, SpeedRatedEvaporatorFanPowerPerVolumeFlowRate2023, SpeedReferenceUnitRatedCondenserAirFlowRate, SpeedReferenceUnitRatedPadEffectivenessofEvapPrecooling, SpeedTotalCoolingCapacityFunctionofTemperatureCurveName, SpeedTotalCoolingCapacityFunctionofAirFlowFractionCurveName, SpeedEnergyInputRatioFunctionofTemperatureCurveName, SpeedEnergyInputRatioFunctionofAirFlowFractionCurveName,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<Coil_Cooling_DX_VariableSpeedExtensibleFields>::integer_value()); }
   private:
...
{ Coil_Cooling_DX_VariableSpeedExtensibleFields::SpeedRatedEvaporatorFanPowerPerVolumeFlowRate2017, "SpeedRatedEvaporatorFanPowerPerVolumeFlowRate2017", "Speed Rated Evaporator Fan Power Per Volume Flow Rate 2017"},
{ Coil_Cooling_DX_VariableSpeedExtensibleFields::SpeedRatedEvaporatorFanPowerPerVolumeFlowRate2023, "SpeedRatedEvaporatorFanPowerPerVolumeFlowRate2023", "Speed Rated Evaporator Fan Power Per Volume Flow Rate 2023"},
