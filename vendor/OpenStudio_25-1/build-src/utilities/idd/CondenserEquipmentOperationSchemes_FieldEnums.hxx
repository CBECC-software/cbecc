...
Name,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<CondenserEquipmentOperationSchemesFields>::integer_value()); }
   private:
...
ControlSchemeObjectType, ControlSchemeName, ControlSchemeScheduleName,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<CondenserEquipmentOperationSchemesExtensibleFields>::integer_value()); }
   private:
