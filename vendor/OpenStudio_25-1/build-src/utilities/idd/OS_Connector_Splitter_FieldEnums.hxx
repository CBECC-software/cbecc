...
Handle, Name, InletBranchName,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<OS_Connector_SplitterFields>::integer_value()); }
   private:
...
OutletBranchName,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<OS_Connector_SplitterExtensibleFields>::integer_value()); }
   private:
