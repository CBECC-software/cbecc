...
Name,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<ConnectorListFields>::integer_value()); }
   private:
...
ConnectorObjectType, ConnectorName,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<ConnectorListExtensibleFields>::integer_value()); }
   private:
