...
Handle, Name, ScheduleTypeLimitsName, InterpolatetoTimestep, OutOfRangeValue, StartMonth, StartDay,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<OS_Schedule_VariableIntervalFields>::integer_value()); }
   private:
...
Month, Day, Hour, Minute, ValueUntilTime,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<OS_Schedule_VariableIntervalExtensibleFields>::integer_value()); }
   private:
