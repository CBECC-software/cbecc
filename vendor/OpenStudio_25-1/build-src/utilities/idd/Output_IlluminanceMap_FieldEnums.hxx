...
class Output_IlluminanceMapFields: public ::EnumBase<Output_IlluminanceMapFields> {
 public: 
  enum domain 
  {
Name, ZoneorSpaceName, Zheight, XMinimumCoordinate, XMaximumCoordinate, NumberofXGridPoints, YMinimumCoordinate, YMaximumCoordinate, NumberofYGridPoints,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<Output_IlluminanceMapFields>::integer_value()); }
   private:
...
{ Output_IlluminanceMapFields::ZoneorSpaceName, "ZoneorSpaceName", "Zone or Space Name"},
