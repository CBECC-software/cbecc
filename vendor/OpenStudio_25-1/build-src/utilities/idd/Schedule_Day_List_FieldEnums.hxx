...
Name, ScheduleTypeLimitsName, InterpolatetoTimestep, MinutesperItem,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<Schedule_Day_ListFields>::integer_value()); }
   private:
...
Value,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<Schedule_Day_ListExtensibleFields>::integer_value()); }
   private:
