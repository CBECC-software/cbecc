...
class OS_AvailabilityManager_NightCycleFields: public ::EnumBase<OS_AvailabilityManager_NightCycleFields> {
 public: 
  enum domain 
  {
Handle, Name, ApplicabilitySchedule, FanSchedule, ControlType, ThermostatTolerance, CyclingRunTime, ControlThermalZone,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<OS_AvailabilityManager_NightCycleFields>::value()); }
   private:
...
{ OS_AvailabilityManager_NightCycleFields::ControlThermalZone, "ControlThermalZone", "Control Thermal Zone"},
        { 0,0,0 }
      };
      VecType v;
      int i = 0;
