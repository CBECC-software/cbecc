...
class UtilityCost_Charge_SimpleFields: public ::EnumBase<UtilityCost_Charge_SimpleFields> {
 public: 
  enum domain 
  {
Name, TariffName, SourceVariable, Season, CategoryVariableName, CostperUnitValueorVariableName,   };
  UtilityCost_Charge_SimpleFields()
   : EnumBase<UtilityCost_Charge_SimpleFields>(Name) {} 
  ...
  domain value() const { return static_cast<domain>(EnumBase<UtilityCost_Charge_SimpleFields>::value()); }
   private:
    ...
    static VecType buildStringVec(bool isd)
    {
      ...
      const evalue a[] =
      {
{ UtilityCost_Charge_SimpleFields::Name, "Name", "Name"},
