...
class OS_Coil_Heating_Gas_MultiStage_StageDataFields: public ::EnumBase<OS_Coil_Heating_Gas_MultiStage_StageDataFields> {
 public: 
  enum domain 
  {
Handle, Name, GasBurnerEfficiency, NominalCapacity, ParasiticElectricLoad,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<OS_Coil_Heating_Gas_MultiStage_StageDataFields>::value()); }
   private:
...
{ OS_Coil_Heating_Gas_MultiStage_StageDataFields::ParasiticElectricLoad, "ParasiticElectricLoad", "Parasitic Electric Load"},
        { 0,0,0 }
      };
      VecType v;
      int i = 0;
