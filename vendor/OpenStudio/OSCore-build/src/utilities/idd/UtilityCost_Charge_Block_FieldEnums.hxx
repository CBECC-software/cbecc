...
class UtilityCost_Charge_BlockFields: public ::EnumBase<UtilityCost_Charge_BlockFields> {
 public: 
  enum domain 
  {
Name, TariffName, SourceVariable, Season, CategoryVariableName, RemainingIntoVariable, BlockSizeMultiplierValueorVariableName,   };
  UtilityCost_Charge_BlockFields()
   : EnumBase<UtilityCost_Charge_BlockFields>(Name) {} 
  ...
  domain value() const { return static_cast<domain>(EnumBase<UtilityCost_Charge_BlockFields>::value()); }
   private:
    ...
    static VecType buildStringVec(bool isd)
    {
      ...
      const evalue a[] =
      {
{ UtilityCost_Charge_BlockFields::Name, "Name", "Name"},
