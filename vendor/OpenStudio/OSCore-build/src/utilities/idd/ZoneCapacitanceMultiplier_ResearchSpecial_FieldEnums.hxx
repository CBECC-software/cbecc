...
class ZoneCapacitanceMultiplier_ResearchSpecialFields: public ::EnumBase<ZoneCapacitanceMultiplier_ResearchSpecialFields> {
 public: 
  enum domain 
  {
TemperatureCapacityMultiplier, HumidityCapacityMultiplier, CarbonDioxideCapacityMultiplier, GenericContaminantCapacityMultiplier,   };
  ZoneCapacitanceMultiplier_ResearchSpecialFields()
   : EnumBase<ZoneCapacitanceMultiplier_ResearchSpecialFields>(TemperatureCapacityMultiplier) {} 
