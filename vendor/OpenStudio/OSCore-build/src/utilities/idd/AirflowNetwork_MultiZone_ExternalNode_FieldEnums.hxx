...
class AirflowNetwork_MultiZone_ExternalNodeFields: public ::EnumBase<AirflowNetwork_MultiZone_ExternalNodeFields> {
 public: 
  enum domain 
  {
Name, ExternalNodeHeight, WindPressureCoefficientValuesObjectName,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<AirflowNetwork_MultiZone_ExternalNodeFields>::value()); }
   private:
...
{ AirflowNetwork_MultiZone_ExternalNodeFields::WindPressureCoefficientValuesObjectName, "WindPressureCoefficientValuesObjectName", "Wind Pressure Coefficient Values Object Name"},
        { 0,0,0 }
      };
      VecType v;
      int i = 0;
