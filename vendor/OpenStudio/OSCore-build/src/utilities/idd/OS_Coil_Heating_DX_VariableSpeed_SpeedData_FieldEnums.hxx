...
class OS_Coil_Heating_DX_VariableSpeed_SpeedDataFields: public ::EnumBase<OS_Coil_Heating_DX_VariableSpeed_SpeedDataFields> {
 public: 
  enum domain 
  {
Handle, Name, ReferenceUnitGrossRatedHeatingCapacity, ReferenceUnitGrossRatedHeatingCOP, ReferenceUnitRatedAirFlowRate, HeatingCapacityFunctionofTemperatureCurveName, TotalHeatingCapacityFunctionofAirFlowFractionCurveName, EnergyInputRatioFunctionofTemperatureCurveName, EnergyInputRatioFunctionofAirFlowFractionCurveName,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<OS_Coil_Heating_DX_VariableSpeed_SpeedDataFields>::value()); }
   private:
