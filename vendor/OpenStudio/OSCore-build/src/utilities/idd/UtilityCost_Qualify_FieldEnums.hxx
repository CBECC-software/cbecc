...
class UtilityCost_QualifyFields: public ::EnumBase<UtilityCost_QualifyFields> {
 public: 
  enum domain 
  {
Name, TariffName, VariableName, QualifyType, ThresholdValueorVariableName, Season, ThresholdTest, NumberofMonths,   };
  UtilityCost_QualifyFields()
   : EnumBase<UtilityCost_QualifyFields>(Name) {} 
  ...
  domain value() const { return static_cast<domain>(EnumBase<UtilityCost_QualifyFields>::value()); }
   private:
    ...
    static VecType buildStringVec(bool isd)
    {
      ...
      const evalue a[] =
      {
{ UtilityCost_QualifyFields::Name, "Name", "Name"},
