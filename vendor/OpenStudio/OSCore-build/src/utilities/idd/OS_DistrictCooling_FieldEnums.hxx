...
class OS_DistrictCoolingFields: public ::EnumBase<OS_DistrictCoolingFields> {
 public: 
  enum domain 
  {
Handle, Name, ChilledWaterInletNodeName, ChilledWaterOutletNodeName, NominalCapacity,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<OS_DistrictCoolingFields>::value()); }
   private:
