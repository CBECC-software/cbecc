...
class RoomAir_TemperaturePattern_ConstantGradientFields: public ::EnumBase<RoomAir_TemperaturePattern_ConstantGradientFields> {
 public: 
  enum domain 
  {
Name, ControlIntegerforPatternControlScheduleName, ThermostatOffset, ReturnAirOffset, ExhaustAirOffset, TemperatureGradient,   };
  RoomAir_TemperaturePattern_ConstantGradientFields()
   : EnumBase<RoomAir_TemperaturePattern_ConstantGradientFields>(Name) {} 
  ...
  domain value() const { return static_cast<domain>(EnumBase<RoomAir_TemperaturePattern_ConstantGradientFields>::value()); }
   private:
    ...
    static VecType buildStringVec(bool isd)
    {
      ...
      const evalue a[] =
      {
{ RoomAir_TemperaturePattern_ConstantGradientFields::Name, "Name", "Name"},
