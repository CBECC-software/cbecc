...
class OS_Coil_Heating_GasFields: public ::EnumBase<OS_Coil_Heating_GasFields> {
 public: 
  enum domain 
  {
Handle, Name, AvailabilityScheduleName, GasBurnerEfficiency, NominalCapacity, AirInletNodeName, AirOutletNodeName, TemperatureSetpointNodeName, ParasiticElectricLoad, PartLoadFractionCorrelationCurveName, ParasiticGasLoad,   };
