...
Name, ConstructionName, BuildingSurfaceName, ShadingControlName, FrameandDividerName, Multiplier, StartingXCoordinate, StartingZCoordinate, Length, Height,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<GlazedDoorFields>::value()); }
   private:
...
{ GlazedDoorFields::ShadingControlName, "ShadingControlName", "Shading Control Name"},
