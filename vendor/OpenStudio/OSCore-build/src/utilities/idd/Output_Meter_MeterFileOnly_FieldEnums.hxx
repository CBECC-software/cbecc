...
Name, ReportingFrequency,   };
  Output_Meter_MeterFileOnlyFields()
   : EnumBase<Output_Meter_MeterFileOnlyFields>(Name) {} 
  ...
  domain value() const { return static_cast<domain>(EnumBase<Output_Meter_MeterFileOnlyFields>::value()); }
   private:
    ...
    static VecType buildStringVec(bool isd)
    {
      ...
      const evalue a[] =
      {
{ Output_Meter_MeterFileOnlyFields::Name, "Name", "Name"},
