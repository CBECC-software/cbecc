...
class RunPeriodFields: public ::EnumBase<RunPeriodFields> {
 public: 
  enum domain 
  {
Name, BeginMonth, BeginDayofMonth, EndMonth, EndDayofMonth, DayofWeekforStartDay, UseWeatherFileHolidaysandSpecialDays, UseWeatherFileDaylightSavingPeriod, ApplyWeekendHolidayRule, UseWeatherFileRainIndicators, UseWeatherFileSnowIndicators, NumberofTimesRunperiodtobeRepeated, IncrementDayofWeekonrepeat, StartYear,   };
  RunPeriodFields()
  ...
  domain value() const { return static_cast<domain>(EnumBase<RunPeriodFields>::value()); }
   private:
...
{ RunPeriodFields::NumberofTimesRunperiodtobeRepeated, "NumberofTimesRunperiodtobeRepeated", "Number of Times Runperiod to be Repeated"},
{ RunPeriodFields::IncrementDayofWeekonrepeat, "IncrementDayofWeekonrepeat", "Increment Day of Week on repeat"},
{ RunPeriodFields::StartYear, "StartYear", "Start Year"},
        { 0,0,0 }
      };
      VecType v;
      int i = 0;
