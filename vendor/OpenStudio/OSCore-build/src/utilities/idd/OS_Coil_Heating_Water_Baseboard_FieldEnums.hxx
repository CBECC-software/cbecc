...
class OS_Coil_Heating_Water_BaseboardFields: public ::EnumBase<OS_Coil_Heating_Water_BaseboardFields> {
 public: 
  enum domain 
  {
Handle, Name, UFactorTimesAreaValue, MaximumWaterFlowRate, ConvergenceTolerance, WaterInletNodeName, WaterOutletNodeName,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<OS_Coil_Heating_Water_BaseboardFields>::value()); }
   private:
