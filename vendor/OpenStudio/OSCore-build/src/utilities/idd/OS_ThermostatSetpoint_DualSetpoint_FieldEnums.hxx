...
class OS_ThermostatSetpoint_DualSetpointFields: public ::EnumBase<OS_ThermostatSetpoint_DualSetpointFields> {
 public: 
  enum domain 
  {
Handle, Name, HeatingSetpointTemperatureScheduleName, CoolingSetpointTemperatureScheduleName,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<OS_ThermostatSetpoint_DualSetpointFields>::value()); }
   private:
