...
class OS_Fan_ZoneExhaustFields: public ::EnumBase<OS_Fan_ZoneExhaustFields> {
 public: 
  enum domain 
  {
Handle, Name, AvailabilityScheduleName, FanEfficiency, PressureRise, MaximumFlowRate, AirInletNodeName, AirOutletNodeName, EndUseSubcategory, FlowFractionScheduleName, SystemAvailabilityManagerCouplingMode, MinimumZoneTemperatureLimitScheduleName, BalancedExhaustFractionScheduleName,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<OS_Fan_ZoneExhaustFields>::value()); }
   private:
...
{ OS_Fan_ZoneExhaustFields::FanEfficiency, "FanEfficiency", "Fan Efficiency"},
