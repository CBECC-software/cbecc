...
class OS_AirTerminal_DualDuct_VAV_OutdoorAirFields: public ::EnumBase<OS_AirTerminal_DualDuct_VAV_OutdoorAirFields> {
 public: 
  enum domain 
  {
Handle, Name, AvailabilitySchedule, AirOutletNode, OutdoorAirInletNode, RecirculatedAirInletNode, MaximumTerminalAirFlowRate, DesignSpecificationOutdoorAirObject, PerPersonVentilationRateMode,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<OS_AirTerminal_DualDuct_VAV_OutdoorAirFields>::value()); }
   private:
...
{ OS_AirTerminal_DualDuct_VAV_OutdoorAirFields::DesignSpecificationOutdoorAirObject, "DesignSpecificationOutdoorAirObject", "Design Specification Outdoor Air Object"},
