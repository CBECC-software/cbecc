...
class OS_AirTerminal_SingleDuct_InletSideMixerFields: public ::EnumBase<OS_AirTerminal_SingleDuct_InletSideMixerFields> {
 public: 
  enum domain 
  {
Handle, Name, TerminalUnitOutlet, TerminalUnitPrimaryAirInlet, TerminalUnitSecondaryAirInlet,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<OS_AirTerminal_SingleDuct_InletSideMixerFields>::value()); }
   private:
