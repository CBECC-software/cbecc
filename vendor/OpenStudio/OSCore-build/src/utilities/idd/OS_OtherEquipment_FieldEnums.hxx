...
class OS_OtherEquipmentFields: public ::EnumBase<OS_OtherEquipmentFields> {
 public: 
  enum domain 
  {
Handle, Name, OtherEquipmentDefinitionName, SpaceorSpaceTypeName, ScheduleName, Multiplier,   };
  ...
  domain value() const { return static_cast<domain>(EnumBase<OS_OtherEquipmentFields>::value()); }
   private:
