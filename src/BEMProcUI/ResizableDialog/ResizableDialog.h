...
protected:
// RW CHANGE -> Moved the two members below to protected from private allow for our derived classes to access them
...
protected:
	void AddAnchor(HWND wnd, CSize tl_type,
		CSize br_type = NOANCHOR, BOOL bForceRefresh = FALSE);	// add anchors to a control
